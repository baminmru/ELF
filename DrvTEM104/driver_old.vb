...
getInfo:
    ...
    Public Overrides Function WriteErrToDB(ByVal ErrDate As Date, ByVal ErrMsg As String) As String
        Dim SSS As String
        SSS = "INSERT INTO " & "TPLC_M" & "(TPLC_MID,instanceid,DCALL,DCOUNTER,hc,hc_1,hc_2) values ("
    ...
    'Public Overrides Function OpenPort() As Boolean
    ...
    Public Sub ReadFlash(ByVal fistpage As Integer, ByVal ReadPageCount As Integer)
