...
finalRet:
    ...
    Public Function writeMessage(ByVal buf() As Byte, ByVal ret As Short) As String
        ...
        Try
            ...
            If (buf(2) = &H45 And IsmArchToRead = True) Then 'чтение мгновенного архива
                ...
                Try
                    mArch.DateArch = New DateTime(CType(mArch.DateArchYear, Long), CType(mArch.DateArchMonth, Long), CType(mArch.DateArchDay, Long), CType(mArch.DateArchHour, Long), 0, 0)
                Catch ex As Exception
            ...
            If (buf(2) = &H42) Then 'часовой архив
                ...
                Arch.НС = Asc(Mid(hourstr, Adr + 4 * 10, 1))
                Arch.НСEnt2 = Asc(Mid(hourstr, Adr + 4 * 10 + 1, 1))
    ...
    Public Overrides Function WriteArchToDB() As String
        WriteArchToDB = "INSERT INTO " + TableForArch(Arch.archType) + "(" + TableForArch(Arch.archType) + "id,instanceid,DCALL,DCOUNTER,id_ptype,v1,v2,v3,v4,m1,m2,m3,m4,t1,t2,t3,t4,HC,Q1,Q2) values ("
       WriteArchToDB = WriteArchToDB + "" + GUID2String(MyManager.Session, Guid.NewGuid) + ","
        ...
        WriteArchToDB = WriteArchToDB + Arch.НС.ToString.Replace(",", ".") + ","
    ...
    Public Overrides Function WriteMArchToDB() As String
        WriteMArchToDB = "INSERT INTO " + TableForArch(1) + "(" + TableForArch(1) + "id,instanceid,DCALL,DCOUNTER,HC) values ("
        ...
        WriteMArchToDB = WriteMArchToDB + MyManager.Session.GetProvider.Date2Const(mArch.DateArch) + ",'Нет мгновенных архивов'"
    ...
    Public Overrides Function WriteTArchToDB() As String
        WriteTArchToDB = "INSERT INTO " + TableForArch(tArch.archType) + "( " + TableForArch(tArch.archType) + "id,instanceid,DCALL,DCOUNTER,id_ptype,v1,v2,v3,v4,Q1,Q2) values ("
