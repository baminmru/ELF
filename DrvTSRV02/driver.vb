...
READMORE:
        ...
        Else
            ...
            MyTransport.SendEvent(UnitransportAction.LowLevelStop, "Данные не получены")
                        ...
                        If VerifySum(buf, sz) Then
                            ...
                            Else
                                ...
                                With Arch
                                    ...
                                    .M4 = GetFlt(buf, 3 + 149 - 1)
                                    .T4 = 0.01 * GetInt(buf, 3 + 151 - 1) '
                                    .P4 = 0.01 * GetInt(buf, 3 + 153 - 1)
   ...
   ByVal ArchMonth As Short, ByVal ArchDay As Short, ByVal ArchHour As Short) As String
    ...
    Public Overrides Function WriteArchToDB() As String
        ...
        WriteArchToDB = "INSERT INTO " + TableForArch(Arch.archType) + "(" + TableForArch(Arch.archType) + "id,instanceid,DCALL,DCOUNTER,t1,t2,t3,t4,t5,t6,p1,p2,p3,p4,p5,p6,v1,v2,v3,v4,v5,v6,m1,m2,m3,m4,m5,m6,q1,q2,q3,q4,q5,hc_code,hc,errtime, errtimeh,worktime,oktime) values ("
        ...
        WriteArchToDB = WriteArchToDB + Format(Arch.P5, "##############0.000").Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + Format(Arch.P6, "##############0.000").Replace(",", ".") + ","
        ...
        WriteArchToDB = WriteArchToDB + Format(Arch.Q4, "##############0.000").Replace(",", ".") + ","
        WriteArchToDB = WriteArchToDB + Format(Arch.Q5, "##############0.000").Replace(",", ".") + ","
    ...
    Public Overrides Function WriteMArchToDB() As String
        WriteMArchToDB = ""
        Try
            WriteMArchToDB = "INSERT INTO " + TableForArch(1) + "(" + TableForArch(1) + "id,instanceid,DCALL,DCOUNTER,t1,t2,t3,t4,t5,t6,v1,v2,v3,v4,v5,v6,M1,M2,M3,M4,M5,M6,P1,P2,P3,P4,P5,P6,g1,G2,g3,g4,g5,g6,hc_code,hc,hc_1,hc_2) values ("
    ...
    Public Overrides Function ReadMArch() As String
        ...
        mArch.t2 = ReadFloat(349193UL - 1) * 100.0
        ...
        'mArch.HC1 = ReadInt(16385UL - 1)
        'mArch.HC2 = ReadInt(16385UL - 1)
    ...
    Public Overrides Function WriteTArchToDB() As String
        WriteTArchToDB = "INSERT INTO " + TableForArch(tArch.archType) + "( " + TableForArch(tArch.archType) + "id,instanceid,DCALL,DCOUNTER,Q1,Q2,Q3,Q4,Q5,Q1H,M1,M2,M3,M4,M5,M6,v1,v2,v3,v4,v5,v6,TSUM1,TSUM2,worktime,ERRTIME) values ("
