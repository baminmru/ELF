...
Public Class driver
    ...
    ByVal ArchMonth As Short, ByVal ArchDay As Short, ByVal ArchHour As Short) As String
        ...
        '                EraseInputQueue()
        '                Return "Ошибка переключения на ТВ1"
        '            End If
        '            trycnt = 5
        'tryagain1:
        ...
        '            If (ret.Length = 0) Then
        '                EraseInputQueue()
        '                Return "Ошибка перключения на ТВ2"
        '            End If
...
finalRet:
    ...
    Public Overrides Function ReadTArch() As String
        ...
        If InpStrB.Length <> 0 Then
            ...
            If InpStrB.Length <> 0 Then
                ...
                tArch.Q3 = tArch.Q2 + FloatExt(Mid(InpStrB, 1 + 4 * 6, 4))
                tArch.TW2 = tArch.TW2 + FloatExt(Mid(InpStrB, 1 + 4 * 7, 4))
                tArch.Q4 = tArch.Q2 + FloatExt(Mid(InpStrB, 1 + 4 * 8, 4))
            Else
                Return "Ошибка чтения тотального архива "
            End If
        Else
    ...
    'Private m_"datacurr" As String = "datacurr"

    'Public Overrides Property "datacurr"() As String
    '    Get
    '        Return (m_"datacurr")
    '    End Get
