...
Public Class driver
    ...
    Private Structure TArchive
        ...
        Public Q3 As Double
        Public Q4 As Double
        Public QG1 As Double
        Public QG2 As Double
...
tryagain1:
        ...
        If (ArchType = archType_day) Then
            ...
            Arch.DateArch = Arch.DateArch.AddDays(-1)
            bArr(2) = &H59
            bArr(3) = Arch.DateArch.Year - 1900
            bArr(4) = Arch.DateArch.Month Mod 13
            bArr(5) = Arch.DateArch.Day Mod 32
            bArr(6) = &H0
            Arch.DateArch = New DateTime(ArchYear, ArchMonth, ArchDay, 0, 0, 0)
            Arch.DateArch = Arch.DateArch.AddSeconds(-1)
        End If
...
finalRet:
    ...
    Public Function writeMessage54(ByVal buf() As Byte, ByVal ret As Short) As String
        ...
        Try
            ...
            If (buf(2) = &H48) Then 'часовой архив
                ...
                Arch.MsgHCtv1 = DeCodeHC54(Arch.HCtv1)
    ...
    Public Function DeCodeHCNumber54(ByVal CodeHC As Long, ByVal tv As Int32) As String
        ...
        If CodeHC And 2 ^ 0 Then
            DeCodeHCNumber54 = "TB" + tv.ToString + ":HC00" + ";"
        End If

        If CodeHC And 2 ^ 1 Then
            DeCodeHCNumber54 = DeCodeHCNumber54 + "TB" + tv.ToString + ":HC01" + ";"
        End If

        If CodeHC And 2 ^ 2 Then
            DeCodeHCNumber54 = DeCodeHCNumber54 + "TB" + tv.ToString + ":HC02" + ";"
        End If
        If CodeHC And 2 ^ 3 Then
            DeCodeHCNumber54 = DeCodeHCNumber54 + "TB" + tv.ToString + ":HC03" + ";"
        End If
        If CodeHC And 2 ^ 4 Then
            DeCodeHCNumber54 = DeCodeHCNumber54 + "TB" + tv.ToString + ":HC04" + ";"
        End If
        If CodeHC And 2 ^ 5 Then
            DeCodeHCNumber54 = DeCodeHCNumber54 + "TB" + tv.ToString + ":HC05" + ";"
    ...
    Public Function DeCodeHC54(ByVal CodeHC As Long) As String
        ...
        'CodeHC = CodeHC And ( 2 ^ 5 + 2 ^ 4 + 2 ^ 3 + 2 ^ 2 + 2 ^ 1 + 2 ^ 0)
        If CodeHC And 2 ^ 0 Then
            DeCodeHC54 = "HC:0 - Разряд батареи" & vbCrLf
        End If

        If CodeHC And 2 ^ 1 Then
            DeCodeHC54 = DeCodeHC54 _
                    & "HC:1 - T1 вне 0-176гр.С" & vbCrLf
        End If

        If CodeHC And 2 ^ 2 Then
            DeCodeHC54 = DeCodeHC54 _
                    & "HC:2 - T2 вне 0-176гр.С" & vbCrLf
        End If

        If CodeHC And 2 ^ 3 Then
            DeCodeHC54 = DeCodeHC54 _
                    & "HC:3 - Перегрузка питания" & vbCrLf
        End If

        If CodeHC And 2 ^ 4 Then
            DeCodeHC54 = DeCodeHC54 _
                    & "HC:4 - M3ч < -0.04M1" & vbCrLf
        End If
    ...
    Public Function DeCodeHCNumber(ByVal CodeHC As Long, ByVal tv As Int32) As String
        ...
        'CodeHC = CodeHC And ( 2 ^ 5 + 2 ^ 4 + 2 ^ 3 + 2 ^ 2 + 2 ^ 1 + 2 ^ 0)
        If CodeHC And 2 ^ 0 Then
            DeCodeHCNumber = "TB" + tv.ToString + ":HC00" + ";"
        End If

        If CodeHC And 2 ^ 1 Then
            DeCodeHCNumber = DeCodeHCNumber + "TB" + tv.ToString + ":HC01" + ";"
        End If

        If CodeHC And 2 ^ 2 Then
            DeCodeHCNumber = DeCodeHCNumber + "TB" + tv.ToString + ":HC02" + ";"
        End If
        If CodeHC And 2 ^ 3 Then
            DeCodeHCNumber = DeCodeHCNumber + "TB" + tv.ToString + ":HC03" + ";"
        End If
        If CodeHC And 2 ^ 4 Then
            DeCodeHCNumber = DeCodeHCNumber + "TB" + tv.ToString + ":HC04" + ";"
        End If
        If CodeHC And 2 ^ 5 Then
            DeCodeHCNumber = DeCodeHCNumber + "TB" + tv.ToString + ":HC05" + ";"
        End If
        If CodeHC And 2 ^ 6 Then
            DeCodeHCNumber = DeCodeHCNumber + "TB" + tv.ToString + ":HC06" + ";"
        End If
        If CodeHC And 2 ^ 7 Then
            DeCodeHCNumber = DeCodeHCNumber + "TB" + tv.ToString + ":HC07" + ";"
        End If
    ...
    Public Function ReadSystemParameters54() As System.Data.DataTable
        ...
        If InpStrS <> "" Then
            ...
            'float	tx КоHCтанта температуры холодной воды
            dr = dt.NewRow
            dr("Название") = "КоHCтанта температуры холодной воды"
            dr("Значение") = FloatExt(Mid(InpStrS, 1 + 4 * 4, 4))
            dt.Rows.Add(dr)

            'float	t3 КоHCтанта температуры в 3 трубопроводе
            dr = dt.NewRow
            dr("Название") = "КоHCтанта температуры в 3 трубопроводе"
            dr("Значение") = FloatExt(Mid(InpStrS, 1 + 4 * 5, 4))
            dt.Rows.Add(dr)

            'float	P1 КоHCтанта давления в 1-м трубопроводе
            dr = dt.NewRow
            dr("Название") = "КоHCтанта давления в 1-м трубопроводе"
            dr("Значение") = FloatExt(Mid(InpStrS, 1 + 4 * 6, 4))
            dt.Rows.Add(dr)

            'float	 P2 КоHCтанта давления во 2-м трубопроводе
            dr = dt.NewRow
            dr("Название") = "КоHCтанта давления во 2-м трубопроводе"
            dr("Значение") = FloatExt(Mid(InpStrS, 1 + 4 * 7, 4))
            dt.Rows.Add(dr)

            'float	P3 КоHCтанта давления в 3-м трубопроводе
            dr = dt.NewRow
            dr("Название") = "КоHCтанта давления в 3-м трубопроводе"
    ...
    Public Overrides Function ReadSystemParameters() As System.Data.DataTable
        ...
        If InpStrG <> "" Then
            ...
            dr = dt.NewRow
            dr("Название") = "КоHCтанта расхода по трубопроводу 1"
            ...
            dr = dt.NewRow
            dr("Название") = "КоHCтанта расхода по трубопроводу 2"
            ...
            dr = dt.NewRow
            dr("Название") = "КоHCтанта расхода по трубопроводу 3"
            ...
            dr = dt.NewRow
            dr("Название") = "КоHCтанта давления по трубопроводу 1"
            dr("Значение") = SysParam(Mid(InpStrG, 30 + 16 * 21, 8))
            dt.Rows.Add(dr)

            dr = dt.NewRow
            dr("Название") = "КоHCтанта температуры по трубопроводу 2"
            dr("Значение") = SysParam(Mid(InpStrG, 30 + 16 * 22, 8))
            dt.Rows.Add(dr)

            dr = dt.NewRow
            dr("Название") = "КоHCтанта давления по трубопроводу 2"
            dr("Значение") = SysParam(Mid(InpStrG, 30 + 16 * 23, 8))
            dt.Rows.Add(dr)

            dr = dt.NewRow
            dr("Название") = "КоHCтанта температуры по трубопроводу 3"
            dr("Значение") = SysParam(Mid(InpStrG, 35 + 16 * 24, 8))
            dt.Rows.Add(dr)

            dr = dt.NewRow
            dr("Название") = "КоHCтанта давления по трубопроводу 3"
            ...
            dr = dt.NewRow
            dr("Название") = "КоHCтанта давления холодной воды"
            dr("Значение") = SysParam(Mid(InpStrG, 35 + 16 * 27, 8))
            dt.Rows.Add(dr)

            dr = dt.NewRow
            dr("Название") = "Алгоритм использования коHCтанты часовой массы"
            dr("Значение") = SysParam(Mid(InpStrG, 40 + 16 * 28, 8))
            dt.Rows.Add(dr)

            dr = dt.NewRow
            dr("Название") = "КоHCтанта часовой массы"
            dr("Значение") = SysParam(Mid(InpStrG, 40 + 16 * 29, 8))
            dt.Rows.Add(dr)

            dr = dt.NewRow
            dr("Название") = "Уставка на небалаHC масс"
            ...
            dr = dt.NewRow
            dr("Название") = "КоHCтанта часового тепла"
    ...
    Public Overrides Function WriteArchToDB() As String
        ...
        WriteArchToDB = "INSERT INTO " & TableForArch(Arch.archType) & "(" & TableForArch(Arch.archType) & "id,instanceid,DCALL,DCOUNTER,t1,t2,t3,t4,t5,t6,tce1,tce2,tair1,tair2,p1,p2,p3,p4,v1,v2,v3,v4,v5,v6,m1,m2,m3,m4,m5,m6,sp_TB1,sp_TB2,q1,q2,q4,q5,TSUM1,TSUM2,hc_code,hc,hc_1,hc_2) values ("
    ...
    Public Overrides Function WriteMArchToDB() As String
        WriteMArchToDB = ""
        Try
            WriteMArchToDB = "INSERT INTO " & TableForArch(mArch.archType) & "(instanceid,DCALL,DCOUNTER,t1,t2,t3,t4,t5,t6,p1,p2,p3,p4,g1,g2,g3,g4,g5,g6,dt12,dt45,sp_TB1,sp_TB2,tce1,tce2,tair1,tair2,hc_code,hc,hc_1,hc_2) values ("
            WriteMArchToDB = WriteMArchToDB + "'" + DeviceID.ToString() + "',"
            WriteMArchToDB = WriteMArchToDB + "getdate()" + ","
    ...
    End Function
	  ...
	  Public Overrides Function WriteTArchToDB() As String
        WriteTArchToDB = "INSERT INTO " & TableForArch(tArch.archType) & "(instanceid,DCALL,DCOUNTER,Q1,Q2,Q3,Q4,M1,M2,M3,M4,M5,M6,v1,v2,v3,v4,v5,v6,TSUM1,TSUM2) values ("
        WriteTArchToDB = WriteTArchToDB + "'" + DeviceID.ToString() + "',"
        WriteTArchToDB = WriteTArchToDB + "getdate()" + ","
