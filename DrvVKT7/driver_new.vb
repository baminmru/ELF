...
Public Class driver
    ...
    ByVal ArchMonth As Short, ByVal ArchDay As Short, ByVal ArchHour As Short) As String
        ...
        Try
            ...
            End If
            If IsError Then
                If VerifyElement(VKT7ElemType.V3_1Type) Then AErr += "V3;"
            End If
            ...
            End If
            If IsError Then
                If VerifyElement(VKT7ElemType.V1_2Type) Then AErr += "V4;"
            End If
            ...
            End If
            If IsError Then
                If VerifyElement(VKT7ElemType.V2_2Type) Then AErr += "V5;"
            End If
            ...
            End If
            If IsError Then
                If VerifyElement(VKT7ElemType.V3_2Type) Then AErr += "V6;"
            End If
    ...
    Private Enum VKT7ElemType
        ...
        QntNS_1 = 79  'Длительность НС по параметрам Тв1 параметр                         
        QntNS_2 = 80  'Длительность НС по параметрам Тв2 параметр                         
	...
	'''''''''''''''''''''''
	 Public Overrides Function WriteArchToDB() As String
        ...
        WriteArchToDB = "INSERT INTO DATACURR(id_bd, id_ptype,DCALL,DCOUNTER,DATECOUNTER,t1,t2,t3,t4,t5,t6,tce1,tce2,tair1,tair2,p1,p2,p3,p4,v1,v2,v3,v4,v5,v6,m1,m2,m3,m4,m5,m6,dm12,V1H,V2H,V5H,V4H,q1h,q2h,sp_TB1,sp_TB2,q1,q2,q4,q5,TSUM1,TSUM2,hc,hc_code,hc_1,hc_2, oktime,oktime2,errtime,errtime2) values ("
    ...
    Public Overrides Function WriteMArchToDB() As String
        WriteMArchToDB = ""
        Try
            WriteMArchToDB = "INSERT INTO DATACURR(id_bd, id_ptype,DCALL,DCOUNTER,DATECOUNTER,t1,t2,t3,t4,t5,t6,p1,p2,p3,p4,g1,g2,g3,g4,g5,g6,v1,v2,v3,v4,sp_TB1,sp_TB2,tce1,tce2,tair1,tair2,hc_code,hc,hc_1,hc_2) values ("
