...
{
    public partial class TeploService : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            InfoReport("Starting TeploService...");
            ...
            if (pMainThread == null)
            {
                InfoReport("Creating TeploService main thread...");
                ...
                pMainThread.Name = "TeploService Main thread! It's need for TeploService's working";
            }
            InfoReport("Starting TeploService main thread...");
            pMainThread.Start();
            //base.OnStart(args); 
        }
        ...
        private void MainThread()
        {
            ...
            try
            {
                InfoReport("Closing TeploService...");
                StopDeviceThreads();
                Threads.Clear();
                Threads = null;
                dr = null;
            ...
            {
                ErrorReport("Closing TeploService error:" + Ex.Message);
            }
