...
function DefineInterface_tplc_m_admin(id,mystore){

var groupingFeature_tplc_m = Ext.create('Ext.grid.feature.Grouping',{
groupByText:  'Группировать по этому полю',
showGroupsText:  'Показать группировку'
});
var filterFeature_tplc_m = {
...
local: true 
 ...
 var p1;
    function onDeleteConfirm(selection){
      if (selection) {
        Ext.Ajax.request({
            url:    rootURL+'index.php/c_tplc_m/deleteRow',
            method:  'POST',
    		params: { 
    				tplc_mid: selection.get('tplc_mid')
    				}
    	});
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_madmin');
                p1.store.insert(0, new model_tplc_m());
 ...
 p1=   new Ext.grid.Panel(
      ...
      stateful:stateFulSystem,
       stateId:  'tplc_madmin',
        ...
        frame: true,
        instanceid: '',
        features: [groupingFeature_tplc_m,filterFeature_tplc_m],
          dockedItems: [{
                xtype:  'toolbar',
                items: [
                {
...
function DefineForms_tplc_m_admin(){


Ext.define('Form_tplc_madmin', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_madmin',
...
allowBlank:true
    ...
    onSave: function(){
        ...
        if (form.isValid()) {
            ...
            Ext.Ajax.request({
                url: rootURL+'index.php/c_tplc_m/setRow',
                method:  'POST',
                params: { 
                    instanceid: this.instanceid
                    ,tplc_mid: active.get('tplc_mid')
	            ...
	            if(res.success==false){
                    ...
                    if(active.get('tplc_mid')==''){
               			active.set('tplc_mid',res.data['tplc_mid']);
                    }
    ...
    onReset: function(){
        if(this.activeRecord.get('tplc_mid')==''){
...
Ext.define('EditWindow_tplc_madmin', {
