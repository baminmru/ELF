...
function DefineInterface_tplc_h_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_h');
...
function DefineForms_tplc_h_(){


Ext.define('Form_tplc_h', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_h',
