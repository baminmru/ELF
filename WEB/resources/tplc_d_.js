...
function DefineInterface_tplc_d_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_d');
...
function DefineForms_tplc_d_(){


Ext.define('Form_tplc_d', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_d',
