...
'Ext.form.*'
 ...
 var enum_ReportD= Ext.create('Ext.data.ArrayStore', {
  ...
  var rpanel= Ext.create('Ext.form.Panel', {
      ...
      fieldDefaults: {
        ...
        items: [
		{
		 ...
		 title: 'Суточные',
		 reportfile:'',
		 html:'<iframe id="rep_d_frame_id" width="100%"  height="100%" src=""></iframe>',
		 rbar:
                [
                {
                    xtype:  'form',
                    ...
                    [
                        {
                            ...
                            handler: function() {
								...
								if(user_input['reportname'] && user_input['device']){
									...
									alert(src);
									Ext.getElementById('rep_d_frame_id').src =encodeURI(src);
								}
