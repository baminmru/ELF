...
function DefineInterface_tplc_m_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_m');
...
function DefineForms_tplc_m_(){


Ext.define('Form_tplc_m', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_m',
