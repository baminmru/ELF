...
function DefineInterface_tpsrv_info_(id,mystore,selection){
...
var p1_valid=false;
     function onSave(close_after_save,callaftersave){
        ...
        if (form.isValid()) {
            ...
            Ext.Ajax.request({
                url: rootURL+'index.php/c_tpsrv_info/setRow',
                method:  'POST',
                params: { 
                    instanceid: p1.instanceid
                    ,tpsrv_infoid: active.get('tpsrv_infoid')
	            ...
	            if(res.success==false){
                    ...
                    if(active.get('tpsrv_infoid')==''){
               			active.set('tpsrv_infoid',res.data['tpsrv_infoid']);
                    }
        		   /* Ext.MessageBox.show({
                        title:  'Подтверждение',
                   ...
                   if(selection){
                     Ext.Ajax.request({
                        url: rootURL+'index.php/c_v_autotpsrv_info/getRows?&filter=[{"property":"tpsrv_infoid","value":"'+ active.get('tpsrv_infoid') + '"}]',
                        method:     'GET',
                        success: function(response){
...
function DefineForms_tpsrv_info_(){


Ext.define('Form_tpsrv_info', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tpsrv_info',
...
allowBlank:true
    ...
    onReset: function(){
        if(this.activeRecord.get('tpsrv_infoid')==''){
...
Ext.define('EditWindow_tpsrv_info', {
