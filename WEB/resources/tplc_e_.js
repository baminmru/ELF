...
function DefineInterface_tplc_e_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_e');
...
function DefineForms_tplc_e_(){


Ext.define('Form_tplc_e', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_e',
