...
function DefineInterface_tplc_e_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_emain');
...
function DefineForms_tplc_e_main(){


Ext.define('Form_tplc_emain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_emain',
...
Ext.define('EditWindow_tplc_emain', {
