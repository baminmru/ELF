...
function DefineInterface_tplc_d_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_dmain');
...
function DefineForms_tplc_d_main(){


Ext.define('Form_tplc_dmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_dmain',
...
Ext.define('EditWindow_tplc_dmain', {
