...
'Ext.form.*'
  ...
  bprcfg_= null;
function bprcfg_Panel_(objectID, RootPanel, selection){ 
    ...
    var store_iu_rcfg_docmode = Ext.create('Ext.data.Store', {
     ...
     bprcfg_= Ext.create('Ext.form.Panel', {
      id: 'bprcfg',
      layout:'fit',
      fieldDefaults: {
          labelAlign:             'top',
...
int_iu_rcfg_docmode_
    ...
    if(RootPanel==true){
       bprcfg_.closable= true;
       bprcfg_.title= 'Настройка роли';
       bprcfg_.frame= true;
    }else{
       bprcfg_.closable= false;
       bprcfg_.title= '';
       bprcfg_.frame= false;
    }
