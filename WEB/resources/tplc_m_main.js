...
function DefineInterface_tplc_m_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_mmain');
...
function DefineForms_tplc_m_main(){


Ext.define('Form_tplc_mmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_mmain',
...
Ext.define('EditWindow_tplc_mmain', {
