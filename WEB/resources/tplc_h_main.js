...
function DefineInterface_tplc_h_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_hmain');
...
function DefineForms_tplc_h_main(){


Ext.define('Form_tplc_hmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_hmain',
...
Ext.define('EditWindow_tplc_hmain', {
