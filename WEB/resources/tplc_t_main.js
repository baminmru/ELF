...
function DefineInterface_tplc_t_main(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_tmain');
...
function DefineForms_tplc_t_main(){


Ext.define('Form_tplc_tmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_tmain',
...
Ext.define('EditWindow_tplc_tmain', {
