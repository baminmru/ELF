...
'Ext.form.*'
  ...
  bprcfg_read= null;
function bprcfg_Panel_read(objectID, RootPanel, selection){ 
    ...
    var store_iu_rcfg_docmode = Ext.create('Ext.data.Store', {
     ...
     bprcfg_read= Ext.create('Ext.form.Panel', {
      id: 'bprcfg',
      layout:'fit',
      fieldDefaults: {
          labelAlign:             'top',
...
int_iu_rcfg_docmode_read
    ...
    if(RootPanel==true){
       bprcfg_read.closable= true;
       bprcfg_read.title= 'Настройка роли';
       bprcfg_read.frame= true;
    }else{
       bprcfg_read.closable= false;
       bprcfg_read.title= '';
       bprcfg_read.frame= false;
    }
