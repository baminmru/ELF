...
function DefineInterface_tplc_t_(id,mystore){
...
local: true 
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('TPLC.edit')!=0){
                var edit = Ext.create('EditWindow_tplc_t');
...
function DefineForms_tplc_t_(){


Ext.define('Form_tplc_t', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplc_t',
