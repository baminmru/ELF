...
function DefineInterface_tplt_connect_(id,mystore){
...
name:   'callerid',
itemId:   'callerid',
fieldLabel:  'Идентификатор промеж. устройства',
allowBlank:true
}
       ], 
       height: 280 
...
function DefineForms_tplt_connect_(){


Ext.define('Form_tplt_connect', {
extend:  'Ext.form.Panel',
alias: 'widget.f_tplt_connect',
...
Ext.define('EditWindow_tplt_connect', {
