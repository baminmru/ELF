...
class  M_iu_int_modules extends CI_Model {
	...
	if (!empty($empId)){
	    $res = $this->jservice->get(array('Action' => 'GetRowData','FieldList'=>'B2G(iu_int_modulesid) as iu_int_modulesid, B2G(iu_int_modulesid) as id,B2G(instanceid) as instanceid, iu_int_modules_BRIEF_F(iu_int_modulesid , NULL) as  brief,sequence,theicon,groupname,name,caption,visiblecontrol, case visiblecontrol  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as visiblecontrol_grid,controldocmode,otherdocmode,mydocmode,allobjects, case allobjects  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as allobjects_grid,colegsobject, case colegsobject  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as colegsobject_grid,substructobjects, case substructobjects  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as substructobjects_grid', 'PartName' => 'iu_int_modules', 'ID' =>  $empId 	));
	    if (!empty($res)) {
	        $result = $res[0];
	    }
	}
    ...
    function getRowsByInstance($id,$sort=array())
		{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_int_modulesid) as iu_int_modulesid, B2G(iu_int_modulesid) as id,B2G(instanceid) as instanceid, iu_int_modules_BRIEF_F(iu_int_modulesid , NULL) as  brief,sequence,theicon,groupname,name,caption,visiblecontrol, case visiblecontrol  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as visiblecontrol_grid,controldocmode,otherdocmode,mydocmode,allobjects, case allobjects  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as allobjects_grid,colegsobject, case colegsobject  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as colegsobject_grid,substructobjects, case substructobjects  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as substructobjects_grid', 'ViewName' => 'iu_int_modules', 'WhereClause' => 'instanceid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
	...
	{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_int_modulesid) as iu_int_modulesid, B2G(iu_int_modulesid) as id,B2G(instanceid) as instanceid, iu_int_modules_BRIEF_F(iu_int_modulesid , NULL) as  brief,sequence,theicon,groupname,name,caption,visiblecontrol, case visiblecontrol  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as visiblecontrol_grid,controldocmode,otherdocmode,mydocmode,allobjects, case allobjects  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as allobjects_grid,colegsobject, case colegsobject  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as colegsobject_grid,substructobjects, case substructobjects  when -1 then \'Да\' when 0 then \'Нет\' else \'\'  end   as substructobjects_grid', 'ViewName' => 'iu_int_modules', 'WhereClause' => ' parentstructrowid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
