...
//////////////////////////// end support file data for: fileref
    ...
    function getRows($sort=array())
		{
	    $res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_taskvideoid) as iu_taskvideoid, B2G(iu_taskvideoid) as id,B2G(instanceid) as instanceid, iu_taskvideo_BRIEF_F(iu_taskvideoid , NULL) as  brief,B2G(DocType) doctype, iud_videotype_BRIEF_F(doctype, NULL) as doctype_grid,  DATE_FORMAT(adddate,\'%Y-%m-%d %H:%i:%s\') as  adddate,activeversion, case activeversion  when -1 then \'Да\' when 0 then \'Нет\'End  as activeversion_grid,fileref,fileref_ext,B2G(AddBy) addby, iu_u_def_BRIEF_F(addby, NULL) as addby_grid,info,fileurl,version,nocomments, case nocomments  when -1 then \'Да\' when 0 then \'Нет\'End  as nocomments_grid', 'ViewName' => 'iu_taskvideo'));
	    if (count($res)) {
	        return $res;
	    } else {
	        return null;
    ...
    function getRowsByInstance($id,$sort=array())
		{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_taskvideoid) as iu_taskvideoid, B2G(iu_taskvideoid) as id,B2G(instanceid) as instanceid, iu_taskvideo_BRIEF_F(iu_taskvideoid , NULL) as  brief,B2G(DocType) doctype, iud_videotype_BRIEF_F(doctype, NULL) as doctype_grid,  DATE_FORMAT(adddate,\'%Y-%m-%d %H:%i:%s\') as  adddate,activeversion, case activeversion  when -1 then \'Да\' when 0 then \'Нет\'End  as activeversion_grid,fileref,fileref_ext,B2G(AddBy) addby, iu_u_def_BRIEF_F(addby, NULL) as addby_grid,info,fileurl,version,nocomments, case nocomments  when -1 then \'Да\' when 0 then \'Нет\'End  as nocomments_grid', 'ViewName' => 'iu_taskvideo', 'WhereClause' => 'instanceid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
	...
	{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_taskvideoid) as iu_taskvideoid, B2G(iu_taskvideoid) as id,B2G(instanceid) as instanceid, iu_taskvideo_BRIEF_F(iu_taskvideoid , NULL) as  brief,B2G(DocType) doctype, iud_videotype_BRIEF_F(doctype, NULL) as doctype_grid,  DATE_FORMAT(adddate,\'%Y-%m-%d %H:%i:%s\') as  adddate,activeversion, case activeversion  when -1 then \'Да\' when 0 then \'Нет\'End  as activeversion_grid,fileref,fileref_ext,B2G(AddBy) addby, iu_u_def_BRIEF_F(addby, NULL) as addby_grid,info,fileurl,version,nocomments, case nocomments  when -1 then \'Да\' when 0 then \'Нет\'End  as nocomments_grid', 'ViewName' => 'iu_taskvideo', 'WhereClause' => ' parentstructrowid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
