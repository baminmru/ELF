...
class  M_iu_regdocs extends CI_Model {
	...
	if (!empty($empId)){
	    $res = $this->jservice->get(array('Action' => 'GetRowData','FieldList'=>'B2G(iu_regdocsid) as iu_regdocsid, B2G(iu_regdocsid) as id,B2G(parentstructrowid) as parentid, iu_regdocs_BRIEF_F(iu_regdocsid , NULL) as  brief,docname,thedoc,thedoc_ext,thecomment', 'PartName' => 'iu_regdocs', 'ID' =>  $empId 	));
	    if (!empty($res)) {
	        $result = $res[0];
	    }
	}
...
//////////////////////////// end support file data for: thedoc
    ...
    function getRows($sort=array())
		{
	    $res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_regdocsid) as iu_regdocsid, B2G(iu_regdocsid) as id,B2G(parentstructrowid) as parentid, iu_regdocs_BRIEF_F(iu_regdocsid , NULL) as  brief,docname,thedoc,thedoc_ext,thecomment', 'ViewName' => 'iu_regdocs'));
	    if (count($res)) {
	        return $res;
	    } else {
	        return null;
    ...
    function getRowsByInstance($id,$sort=array())
		{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_regdocsid) as iu_regdocsid, B2G(iu_regdocsid) as id,B2G(parentstructrowid) as parentid, iu_regdocs_BRIEF_F(iu_regdocsid , NULL) as  brief,docname,thedoc,thedoc_ext,thecomment', 'ViewName' => 'iu_regdocs', 'WhereClause' => 'instanceid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
	...
	{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_regdocsid) as iu_regdocsid, B2G(iu_regdocsid) as id,B2G(parentstructrowid) as parentid, iu_regdocs_BRIEF_F(iu_regdocsid , NULL) as  brief,docname,thedoc,thedoc_ext,thecomment', 'ViewName' => 'iu_regdocs', 'WhereClause' => ' parentstructrowid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
