...
//////////////////////////// end support file data for: thefile
    ...
    function getRowsByInstance($id,$sort=array())
		{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_cm_msgid) as iu_cm_msgid, B2G(iu_cm_msgid) as id,B2G(instanceid) as instanceid,B2G(parentrowid) as parentrowid, iu_cm_msg_BRIEF_F(iu_cm_msgid , NULL) as  brief,B2G(messagetype) messagetype, iud_mt_def_BRIEF_F(messagetype, NULL) as messagetype_grid,  DATE_FORMAT(thedate,\'%Y-%m-%d %H:%i:%s\') as  thedate,B2G(TheAuthor) theauthor, iu_u_def_BRIEF_F(theauthor, NULL) as theauthor_grid,info,thefile,thefile_ext', 'ViewName' => 'iu_cm_msg', 'WhereClause' => 'instanceid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
	...
	{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_cm_msgid) as iu_cm_msgid, B2G(iu_cm_msgid) as id,B2G(instanceid) as instanceid,B2G(parentrowid) as parentrowid, iu_cm_msg_BRIEF_F(iu_cm_msgid , NULL) as  brief,B2G(messagetype) messagetype, iud_mt_def_BRIEF_F(messagetype, NULL) as messagetype_grid,  DATE_FORMAT(thedate,\'%Y-%m-%d %H:%i:%s\') as  thedate,B2G(TheAuthor) theauthor, iu_u_def_BRIEF_F(theauthor, NULL) as theauthor_grid,info,thefile,thefile_ext', 'ViewName' => 'iu_cm_msg', 'WhereClause' => ' parentstructrowid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
    ...
    function getRowsByTree($treeid,$sort=array())
		{
	    $res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_cm_msgid) as iu_cm_msgid, B2G(iu_cm_msgid) as id,B2G(instanceid) as instanceid,B2G(parentrowid) as parentrowid, iu_cm_msg_BRIEF_F(iu_cm_msgid , NULL) as  brief,B2G(messagetype) messagetype, iud_mt_def_BRIEF_F(messagetype, NULL) as messagetype_grid,  DATE_FORMAT(thedate,\'%Y-%m-%d %H:%i:%s\') as  thedate,B2G(TheAuthor) theauthor, iu_u_def_BRIEF_F(theauthor, NULL) as theauthor_grid,info,thefile,thefile_ext', 'ViewName' => 'iu_cm_msg', 'WhereClause' => 'parentrowid=G2B(\''.$treeid.'\')'));
	    if (count($res)) {
	        return $res;
	    } else {
	        return null;
    ...
    function getRowsByInstanceTree($id,$treeid,$sort=array())
		{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_cm_msgid) as iu_cm_msgid, B2G(iu_cm_msgid) as id,B2G(instanceid) as instanceid,B2G(parentrowid) as parentrowid, iu_cm_msg_BRIEF_F(iu_cm_msgid , NULL) as  brief,B2G(messagetype) messagetype, iud_mt_def_BRIEF_F(messagetype, NULL) as messagetype_grid,  DATE_FORMAT(thedate,\'%Y-%m-%d %H:%i:%s\') as  thedate,B2G(TheAuthor) theauthor, iu_u_def_BRIEF_F(theauthor, NULL) as theauthor_grid,info,thefile,thefile_ext', 'ViewName' => 'iu_cm_msg', 'WhereClause' => 'instanceid=G2B(\''. $id . '\') and parentrowid=G2B(\''.$treeid.'\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
	...
	{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_cm_msgid) as iu_cm_msgid, B2G(iu_cm_msgid) as id,B2G(instanceid) as instanceid,B2G(parentrowid) as parentrowid, iu_cm_msg_BRIEF_F(iu_cm_msgid , NULL) as  brief,B2G(messagetype) messagetype, iud_mt_def_BRIEF_F(messagetype, NULL) as messagetype_grid,  DATE_FORMAT(thedate,\'%Y-%m-%d %H:%i:%s\') as  thedate,B2G(TheAuthor) theauthor, iu_u_def_BRIEF_F(theauthor, NULL) as theauthor_grid,info,thefile,thefile_ext', 'ViewName' => 'iu_cm_msg', 'WhereClause' => ' parentstructrowid=G2B(\''. $id . '\') and parentrowid=G2B(\''.$treeid.'\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
