      ...
      function getRowsSL($offset,$limit, $sort = array(), $filter = null)
{
    ...
    try{
	 ...
	 if (isset($offset) && isset($limit)) {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autoiu_task','FieldList'=>'instanceid,id,iu_task_taskcancelled,iu_task_processstatus,iu_task_subj,iu_task_doer_comment,iu_task_controller_comment,iu_task_taskfinished,DATE_FORMAT(iu_task_createdate,\'%Y-%m-%d %H:%i:%s\') iu_task_createdate,iu_task_delegatefrom,iu_task_statetask,iu_task_ischecked,iu_task_contoller,iu_task_doer,iu_task_doer_states,DATE_FORMAT(iu_task_finishdate,\'%Y-%m-%d %H:%i:%s\') iu_task_finishdate,DATE_FORMAT(iu_task_senttodoer,\'%Y-%m-%d %H:%i:%s\') iu_task_senttodoer,iu_task_info,DATE_FORMAT(iu_task_planenddate,\'%Y-%m-%d %H:%i:%s\') iu_task_planenddate','Sort'=>$sort, 'WhereClause' => $whereclause,'Limit'=>$limit,'Offset'=>$offset));
	} else {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autoiu_task','FieldList'=>'instanceid,id,iu_task_taskcancelled,iu_task_processstatus,iu_task_subj,iu_task_doer_comment,iu_task_controller_comment,iu_task_taskfinished,DATE_FORMAT(iu_task_createdate,\'%Y-%m-%d %H:%i:%s\') iu_task_createdate,iu_task_delegatefrom,iu_task_statetask,iu_task_ischecked,iu_task_contoller,iu_task_doer,iu_task_doer_states,DATE_FORMAT(iu_task_finishdate,\'%Y-%m-%d %H:%i:%s\') iu_task_finishdate,DATE_FORMAT(iu_task_senttodoer,\'%Y-%m-%d %H:%i:%s\') iu_task_senttodoer,iu_task_info,DATE_FORMAT(iu_task_planenddate,\'%Y-%m-%d %H:%i:%s\') iu_task_planenddate','Sort'=>$sort, 'WhereClause' => $whereclause));
	}
	$root = new stdClass();
	$root->total = $this->jservice->get(array('Action' => 'CountView', 'ViewName' => 'v_autoiu_task','FieldList'=>'instanceid,id,iu_task_taskcancelled,iu_task_processstatus,iu_task_subj,iu_task_doer_comment,iu_task_controller_comment,iu_task_taskfinished,DATE_FORMAT(iu_task_createdate,\'%Y-%m-%d %H:%i:%s\') iu_task_createdate,iu_task_delegatefrom,iu_task_statetask,iu_task_ischecked,iu_task_contoller,iu_task_doer,iu_task_doer_states,DATE_FORMAT(iu_task_finishdate,\'%Y-%m-%d %H:%i:%s\') iu_task_finishdate,DATE_FORMAT(iu_task_senttodoer,\'%Y-%m-%d %H:%i:%s\') iu_task_senttodoer,iu_task_info,DATE_FORMAT(iu_task_planenddate,\'%Y-%m-%d %H:%i:%s\') iu_task_planenddate', 'WhereClause' => $whereclause));
	$root->success = true;
	$root->rows = $res;
	return $root;
}
