...
//////////////////////////// end support file data for: fileref
    ...
    function getRows($sort=array())
		{
	    $res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_urok_videoid) as iu_urok_videoid, B2G(iu_urok_videoid) as id,B2G(instanceid) as instanceid, iu_urok_video_BRIEF_F(iu_urok_videoid , NULL) as  brief,  DATE_FORMAT(adddate,\'%Y-%m-%d %H:%i:%s\') as  adddate,B2G(DocType) doctype, iud_videotype_BRIEF_F(doctype, NULL) as doctype_grid,activeversion, case activeversion  when -1 then \'Да\' when 0 then \'Нет\'End  as activeversion_grid,B2G(AddBy) addby, iu_u_def_BRIEF_F(addby, NULL) as addby_grid,version,fileurl,fileref,fileref_ext,info,nocomments, case nocomments  when -1 then \'Да\' when 0 then \'Нет\'End  as nocomments_grid', 'ViewName' => 'iu_urok_video'));
	    if (count($res)) {
	        return $res;
	    } else {
	        return null;
    ...
    function getRowsByInstance($id,$sort=array())
		{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_urok_videoid) as iu_urok_videoid, B2G(iu_urok_videoid) as id,B2G(instanceid) as instanceid, iu_urok_video_BRIEF_F(iu_urok_videoid , NULL) as  brief,  DATE_FORMAT(adddate,\'%Y-%m-%d %H:%i:%s\') as  adddate,B2G(DocType) doctype, iud_videotype_BRIEF_F(doctype, NULL) as doctype_grid,activeversion, case activeversion  when -1 then \'Да\' when 0 then \'Нет\'End  as activeversion_grid,B2G(AddBy) addby, iu_u_def_BRIEF_F(addby, NULL) as addby_grid,version,fileurl,fileref,fileref_ext,info,nocomments, case nocomments  when -1 then \'Да\' when 0 then \'Нет\'End  as nocomments_grid', 'ViewName' => 'iu_urok_video', 'WhereClause' => 'instanceid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
	...
	{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_urok_videoid) as iu_urok_videoid, B2G(iu_urok_videoid) as id,B2G(instanceid) as instanceid, iu_urok_video_BRIEF_F(iu_urok_videoid , NULL) as  brief,  DATE_FORMAT(adddate,\'%Y-%m-%d %H:%i:%s\') as  adddate,B2G(DocType) doctype, iud_videotype_BRIEF_F(doctype, NULL) as doctype_grid,activeversion, case activeversion  when -1 then \'Да\' when 0 then \'Нет\'End  as activeversion_grid,B2G(AddBy) addby, iu_u_def_BRIEF_F(addby, NULL) as addby_grid,version,fileurl,fileref,fileref_ext,info,nocomments, case nocomments  when -1 then \'Да\' when 0 then \'Нет\'End  as nocomments_grid', 'ViewName' => 'iu_urok_video', 'WhereClause' => ' parentstructrowid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
