      ...
      function getRowsSL($offset,$limit, $sort = array(), $filter = null)
{
    ...
    try{
	 ...
	 if (isset($offset) && isset($limit)) {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autoiu_cm_def','FieldList'=>'instanceid,id,iu_cm_def_theprocess,iu_cm_def_thedoc,iu_cm_def_isdiscussion,iu_cm_def_theauthor,iu_cm_def_thevideo,DATE_FORMAT(iu_cm_def_thedate,\'%Y-%m-%d %H:%i:%s\') iu_cm_def_thedate,iu_cm_def_thetheme','Sort'=>$sort, 'WhereClause' => $whereclause,'Limit'=>$limit,'Offset'=>$offset));
	} else {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autoiu_cm_def','FieldList'=>'instanceid,id,iu_cm_def_theprocess,iu_cm_def_thedoc,iu_cm_def_isdiscussion,iu_cm_def_theauthor,iu_cm_def_thevideo,DATE_FORMAT(iu_cm_def_thedate,\'%Y-%m-%d %H:%i:%s\') iu_cm_def_thedate,iu_cm_def_thetheme','Sort'=>$sort, 'WhereClause' => $whereclause));
	}
	$root = new stdClass();
	$root->total = $this->jservice->get(array('Action' => 'CountView', 'ViewName' => 'v_autoiu_cm_def','FieldList'=>'instanceid,id,iu_cm_def_theprocess,iu_cm_def_thedoc,iu_cm_def_isdiscussion,iu_cm_def_theauthor,iu_cm_def_thevideo,DATE_FORMAT(iu_cm_def_thedate,\'%Y-%m-%d %H:%i:%s\') iu_cm_def_thedate,iu_cm_def_thetheme', 'WhereClause' => $whereclause));
	$root->success = true;
	$root->rows = $res;
	return $root;
}
