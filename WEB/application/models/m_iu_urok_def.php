...
class  M_iu_urok_def extends CI_Model {
    ...
    function getRows($sort=array())
		{
	    $res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_urok_defid) as iu_urok_defid, B2G(iu_urok_defid) as id,B2G(instanceid) as instanceid, iu_urok_def_BRIEF_F(iu_urok_defid , NULL) as  brief,ucode,  DATE_FORMAT(datecreated,\'%Y-%m-%d %H:%i:%s\') as  datecreated,B2G(subject) subject, iud_predmet_BRIEF_F(subject, NULL) as subject_grid,B2G(theClassnum) theclassnum, iu_clsinfo_BRIEF_F(theclassnum, NULL) as theclassnum_grid,plannum,B2G(maketown) maketown, iud_town_BRIEF_F(maketown, NULL) as maketown_grid,  DATE_FORMAT(actiondate,\'%Y-%m-%d\') as  actiondate,B2G(coursetype) coursetype, iud_ctype_BRIEF_F(coursetype, NULL) as coursetype_grid,rtheme,classtheme,thequarter, case thequarter  when 0 then \'?\' when 1 then \'I\' when 2 then \'II\' when 3 then \'III\' when 4 then \'IV\'End  as thequarter_grid,  schooldate as  schooldate,B2G(curator) curator, iu_u_def_BRIEF_F(curator, NULL) as curator_grid,B2G(theTeacher) theteacher, iu_tmdef_BRIEF_F(theteacher, NULL) as theteacher_grid,B2G(methodist) methodist, iu_tmdef_BRIEF_F(methodist, NULL) as methodist_grid,B2G(methodist2) methodist2, iu_tmdef_BRIEF_F(methodist2, NULL) as methodist2_grid,B2G(processtype) processtype, iud_process_def_BRIEF_F(processtype, NULL) as processtype_grid,testpageref,mainref,B2G(TheFilm) thefilm, iu_urok_def_BRIEF_F(thefilm, NULL) as thefilm_grid,info,notes', 'ViewName' => 'iu_urok_def'));
	    if (count($res)) {
	        return $res;
	    } else {
	        return null;
    ...
    function getRowsByInstance($id,$sort=array())
		{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_urok_defid) as iu_urok_defid, B2G(iu_urok_defid) as id,B2G(instanceid) as instanceid, iu_urok_def_BRIEF_F(iu_urok_defid , NULL) as  brief,ucode,  DATE_FORMAT(datecreated,\'%Y-%m-%d %H:%i:%s\') as  datecreated,B2G(subject) subject, iud_predmet_BRIEF_F(subject, NULL) as subject_grid,B2G(theClassnum) theclassnum, iu_clsinfo_BRIEF_F(theclassnum, NULL) as theclassnum_grid,plannum,B2G(maketown) maketown, iud_town_BRIEF_F(maketown, NULL) as maketown_grid,  DATE_FORMAT(actiondate,\'%Y-%m-%d\') as  actiondate,B2G(coursetype) coursetype, iud_ctype_BRIEF_F(coursetype, NULL) as coursetype_grid,rtheme,classtheme,thequarter, case thequarter  when 0 then \'?\' when 1 then \'I\' when 2 then \'II\' when 3 then \'III\' when 4 then \'IV\'End  as thequarter_grid,  schooldate as  schooldate,B2G(curator) curator, iu_u_def_BRIEF_F(curator, NULL) as curator_grid,B2G(theTeacher) theteacher, iu_tmdef_BRIEF_F(theteacher, NULL) as theteacher_grid,B2G(methodist) methodist, iu_tmdef_BRIEF_F(methodist, NULL) as methodist_grid,B2G(methodist2) methodist2, iu_tmdef_BRIEF_F(methodist2, NULL) as methodist2_grid,B2G(processtype) processtype, iud_process_def_BRIEF_F(processtype, NULL) as processtype_grid,testpageref,mainref,B2G(TheFilm) thefilm, iu_urok_def_BRIEF_F(thefilm, NULL) as thefilm_grid,info,notes', 'ViewName' => 'iu_urok_def', 'WhereClause' => 'instanceid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
	...
	{
	$res = $this->jservice->get(array('Action' => 'GetViewData','Sort'=>$sort,'FieldList'=>'B2G(iu_urok_defid) as iu_urok_defid, B2G(iu_urok_defid) as id,B2G(instanceid) as instanceid, iu_urok_def_BRIEF_F(iu_urok_defid , NULL) as  brief,ucode,  DATE_FORMAT(datecreated,\'%Y-%m-%d %H:%i:%s\') as  datecreated,B2G(subject) subject, iud_predmet_BRIEF_F(subject, NULL) as subject_grid,B2G(theClassnum) theclassnum, iu_clsinfo_BRIEF_F(theclassnum, NULL) as theclassnum_grid,plannum,B2G(maketown) maketown, iud_town_BRIEF_F(maketown, NULL) as maketown_grid,  DATE_FORMAT(actiondate,\'%Y-%m-%d\') as  actiondate,B2G(coursetype) coursetype, iud_ctype_BRIEF_F(coursetype, NULL) as coursetype_grid,rtheme,classtheme,thequarter, case thequarter  when 0 then \'?\' when 1 then \'I\' when 2 then \'II\' when 3 then \'III\' when 4 then \'IV\'End  as thequarter_grid,  schooldate as  schooldate,B2G(curator) curator, iu_u_def_BRIEF_F(curator, NULL) as curator_grid,B2G(theTeacher) theteacher, iu_tmdef_BRIEF_F(theteacher, NULL) as theteacher_grid,B2G(methodist) methodist, iu_tmdef_BRIEF_F(methodist, NULL) as methodist_grid,B2G(methodist2) methodist2, iu_tmdef_BRIEF_F(methodist2, NULL) as methodist2_grid,B2G(processtype) processtype, iud_process_def_BRIEF_F(processtype, NULL) as processtype_grid,testpageref,mainref,B2G(TheFilm) thefilm, iu_urok_def_BRIEF_F(thefilm, NULL) as thefilm_grid,info,notes', 'ViewName' => 'iu_urok_def', 'WhereClause' => ' parentstructrowid=G2B(\''. $id . '\')'));
	if (count($res) == 0) {
	    return null;
	} else {
	    return $res;
