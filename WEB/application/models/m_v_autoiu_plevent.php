      ...
      function getRowsSL($offset,$limit, $sort = array(), $filter = null)
{
    ...
    try{
	 ...
	 if (isset($offset) && isset($limit)) {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autoiu_plevent','FieldList'=>'instanceid,id,iu_plevent_statetask,iu_plevent_thevideo,iu_plevent_eventtype,iu_plevent_theprocess,iu_plevent_thedoc,iu_plevent_info,iu_plevent_thediscussion,iu_plevent_doer,DATE_FORMAT(iu_plevent_createdate,\'%Y-%m-%d %H:%i:%s\') iu_plevent_createdate,iu_plevent_processstatus','Sort'=>$sort, 'WhereClause' => $whereclause,'Limit'=>$limit,'Offset'=>$offset));
	} else {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autoiu_plevent','FieldList'=>'instanceid,id,iu_plevent_statetask,iu_plevent_thevideo,iu_plevent_eventtype,iu_plevent_theprocess,iu_plevent_thedoc,iu_plevent_info,iu_plevent_thediscussion,iu_plevent_doer,DATE_FORMAT(iu_plevent_createdate,\'%Y-%m-%d %H:%i:%s\') iu_plevent_createdate,iu_plevent_processstatus','Sort'=>$sort, 'WhereClause' => $whereclause));
	}
	$root = new stdClass();
	$root->total = $this->jservice->get(array('Action' => 'CountView', 'ViewName' => 'v_autoiu_plevent','FieldList'=>'instanceid,id,iu_plevent_statetask,iu_plevent_thevideo,iu_plevent_eventtype,iu_plevent_theprocess,iu_plevent_thedoc,iu_plevent_info,iu_plevent_thediscussion,iu_plevent_doer,DATE_FORMAT(iu_plevent_createdate,\'%Y-%m-%d %H:%i:%s\') iu_plevent_createdate,iu_plevent_processstatus', 'WhereClause' => $whereclause));
	$root->success = true;
	$root->rows = $res;
	return $root;
}
