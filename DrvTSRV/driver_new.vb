...
READMORE:
   ...
   ByVal ArchMonth As Short, ByVal ArchDay As Short, ByVal ArchHour As Short) As String
    ...
    Public Overrides Function ReadMArch() As String
        ...
        mArch.t4 = ReadFloat(49153UL - 1)
        mArch.t5 = ReadFloat(49155UL - 1)
        mArch.t6 = ReadFloat(49157UL - 1)

        mArch.t1 = ReadFloat(49223UL - 1)
        mArch.t2 = ReadFloat(49225UL - 1)
        mArch.t3 = ReadFloat(49227UL - 1)
   ...
   '''''''''''''''''''''''''''''
    ...
    End Function
     ...
     Public Overrides Function WriteArchToDB() As String
        ...
        WriteArchToDB = "INSERT INTO DATACURR(id_bd, id_ptype,DCALL,DCOUNTER,DATECOUNTER,t1,t2,t3,t4,t5,t6,tce1,tce2,tair1,tair2,p1,p2,p3,p4,v1,v2,v3,v4,v5,v6,m1,m2,m3,m4,m5,m6,dm12,V1H,V2H,V5H,V4H,q1h,q2h,sp_TB1,sp_TB2,q1,q2,q3,q4,q5,TSUM1,TSUM2,hc_code,hc,errtime, errtimeh,worktime,oktime) values ("
        ...
        WriteArchToDB = WriteArchToDB + OracleDate(Arch.DateArch.AddSeconds(-1)) + ","
        WriteArchToDB = WriteArchToDB + OracleDate(Arch.DateArch.AddSeconds(-1)) + ","
    ...
    Public Overrides Function WriteMArchToDB() As String
        WriteMArchToDB = ""
        Try
            WriteMArchToDB = "INSERT INTO DATACURR(id_bd, id_ptype,DCALL,DCOUNTER,DATECOUNTER,t1,t2,t3,t4,t5,t6,v1,v2,v3,M1,M2,M3,g1,G2,g3,dt12,dt45,sp_TB1,sp_TB2,tce1,tce2,tair1,tair2,hc_code,hc,hc_1,hc_2) values ("
