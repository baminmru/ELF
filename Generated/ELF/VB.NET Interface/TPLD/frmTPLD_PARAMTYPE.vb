...
''' <summary>
'''Форма редактирования раздела Тип архива режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLD_PARAMTYPE
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLD_PARAMTYPE As TPLDGUI.editTPLD_PARAMTYPE
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLD_PARAMTYPE = New TPLDGUI.EditTPLD_PARAMTYPE
        ...
        'EditTPLD_PARAMTYPE
        '
        Me.EditTPLD_PARAMTYPE.AutoScroll = True
        Me.EditTPLD_PARAMTYPE.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLD_PARAMTYPE.name = "EditTPLD_PARAMTYPE"
        Me.EditTPLD_PARAMTYPE.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLD_PARAMTYPE.TabIndex = 20
        Me.EditTPLD_PARAMTYPE.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLD_PARAMTYPE
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLD_PARAMTYPE)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLD_PARAMTYPE"
        Me.Text = "Тип архива"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLD.TPLD.TPLD_PARAMTYPE)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLD_PARAMTYPE.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLD_PARAMTYPE_Changed() Handles EditTPLD_PARAMTYPE.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLD_PARAMTYPE.IsOK() Then
          EditTPLD_PARAMTYPE.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLD_PARAMTYPE.GetMaxX() + 10, EditTPLD_PARAMTYPE.GetMaxY() + 35)
