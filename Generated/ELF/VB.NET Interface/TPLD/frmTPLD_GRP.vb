...
''' <summary>
'''Форма редактирования раздела Группа режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLD_GRP
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLD_GRP As TPLDGUI.editTPLD_GRP
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLD_GRP = New TPLDGUI.EditTPLD_GRP
        ...
        'EditTPLD_GRP
        '
        Me.EditTPLD_GRP.AutoScroll = True
        Me.EditTPLD_GRP.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLD_GRP.name = "EditTPLD_GRP"
        Me.EditTPLD_GRP.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLD_GRP.TabIndex = 20
        Me.EditTPLD_GRP.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLD_GRP
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLD_GRP)
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLD.TPLD.TPLD_GRP)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLD_GRP.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLD_GRP_Changed() Handles EditTPLD_GRP.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLD_GRP.GetMaxX() + 10, EditTPLD_GRP.GetMaxY() + 35)
