...
''' <summary>
'''Форма редактирования раздела Тип устройства режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLD_DEVTYPE
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLD_DEVTYPE As TPLDGUI.editTPLD_DEVTYPE
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLD_DEVTYPE = New TPLDGUI.EditTPLD_DEVTYPE
        ...
        'EditTPLD_DEVTYPE
        '
        Me.EditTPLD_DEVTYPE.AutoScroll = True
        Me.EditTPLD_DEVTYPE.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLD_DEVTYPE.name = "EditTPLD_DEVTYPE"
        Me.EditTPLD_DEVTYPE.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLD_DEVTYPE.TabIndex = 20
        Me.EditTPLD_DEVTYPE.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLD_DEVTYPE
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLD_DEVTYPE)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLD_DEVTYPE"
        Me.Text = "Тип устройства"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLD.TPLD.TPLD_DEVTYPE)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLD_DEVTYPE.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLD_DEVTYPE_Changed() Handles EditTPLD_DEVTYPE.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLD_DEVTYPE.IsOK() Then
          EditTPLD_DEVTYPE.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLD_DEVTYPE.GetMaxX() + 10, EditTPLD_DEVTYPE.GetMaxY() + 35)
