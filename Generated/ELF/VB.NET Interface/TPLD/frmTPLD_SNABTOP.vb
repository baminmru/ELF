...
''' <summary>
'''Форма редактирования раздела Поставщик режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLD_SNABTOP
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLD_SNABTOP As TPLDGUI.editTPLD_SNABTOP
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLD_SNABTOP = New TPLDGUI.EditTPLD_SNABTOP
        ...
        'EditTPLD_SNABTOP
        '
        Me.EditTPLD_SNABTOP.AutoScroll = True
        Me.EditTPLD_SNABTOP.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLD_SNABTOP.name = "EditTPLD_SNABTOP"
        Me.EditTPLD_SNABTOP.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLD_SNABTOP.TabIndex = 20
        Me.EditTPLD_SNABTOP.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLD_SNABTOP
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLD_SNABTOP)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLD_SNABTOP"
        Me.Text = "Поставщик"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLD.TPLD.TPLD_SNABTOP)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLD_SNABTOP.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLD_SNABTOP_Changed() Handles EditTPLD_SNABTOP.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLD_SNABTOP.IsOK() Then
          EditTPLD_SNABTOP.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLD_SNABTOP.GetMaxX() + 10, EditTPLD_SNABTOP.GetMaxY() + 35)
