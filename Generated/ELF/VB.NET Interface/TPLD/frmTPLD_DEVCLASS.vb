...
''' <summary>
'''Форма редактирования раздела Класс устройства режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLD_DEVCLASS
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLD_DEVCLASS As TPLDGUI.editTPLD_DEVCLASS
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLD_DEVCLASS = New TPLDGUI.EditTPLD_DEVCLASS
        ...
        'EditTPLD_DEVCLASS
        '
        Me.EditTPLD_DEVCLASS.AutoScroll = True
        Me.EditTPLD_DEVCLASS.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLD_DEVCLASS.name = "EditTPLD_DEVCLASS"
        Me.EditTPLD_DEVCLASS.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLD_DEVCLASS.TabIndex = 20
        Me.EditTPLD_DEVCLASS.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLD_DEVCLASS
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLD_DEVCLASS)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLD_DEVCLASS"
        Me.Text = "Класс устройства"
...
#End Region
    Public Item As TPLD.TPLD.TPLD_DEVCLASS
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLD.TPLD.TPLD_DEVCLASS)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLD_DEVCLASS.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLD_DEVCLASS_Changed() Handles EditTPLD_DEVCLASS.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLD_DEVCLASS.IsOK() Then
          EditTPLD_DEVCLASS.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLD_DEVCLASS.GetMaxX() + 10, EditTPLD_DEVCLASS.GetMaxY() + 35)
