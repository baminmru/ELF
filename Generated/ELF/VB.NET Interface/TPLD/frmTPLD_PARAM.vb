...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLD_PARAM As TPLDGUI.editTPLD_PARAM
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLD_PARAM = New TPLDGUI.EditTPLD_PARAM
        ...
        'EditTPLD_PARAM
        '
        Me.EditTPLD_PARAM.AutoScroll = True
        Me.EditTPLD_PARAM.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLD_PARAM.name = "EditTPLD_PARAM"
        Me.EditTPLD_PARAM.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLD_PARAM.TabIndex = 20
        Me.EditTPLD_PARAM.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLD_PARAM
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLD_PARAM)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLD_PARAM"
        Me.Text = "Параметры"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLD.TPLD.TPLD_PARAM)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLD_PARAM.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLD_PARAM_Changed() Handles EditTPLD_PARAM.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLD_PARAM.GetMaxX() + 10, EditTPLD_PARAM.GetMaxY() + 35)
