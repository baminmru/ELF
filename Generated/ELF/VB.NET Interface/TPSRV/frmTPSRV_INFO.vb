...
''' <summary>
'''Форма редактирования раздела Описание сервера режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPSRV_INFO
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPSRV_INFO As TPSRVGUI.editTPSRV_INFO
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPSRV_INFO = New TPSRVGUI.EditTPSRV_INFO
        ...
        'EditTPSRV_INFO
        '
        Me.EditTPSRV_INFO.AutoScroll = True
        Me.EditTPSRV_INFO.Location = New System.Drawing.Point(8, 8)
        Me.EditTPSRV_INFO.name = "EditTPSRV_INFO"
        Me.EditTPSRV_INFO.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPSRV_INFO.TabIndex = 20
        Me.EditTPSRV_INFO.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPSRV_INFO
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPSRV_INFO)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPSRV_INFO"
        Me.Text = "Описание сервера"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPSRV.TPSRV.TPSRV_INFO)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPSRV_INFO.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPSRV_INFO_Changed() Handles EditTPSRV_INFO.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPSRV_INFO.GetMaxX() + 10, EditTPSRV_INFO.GetMaxY() + 35)
