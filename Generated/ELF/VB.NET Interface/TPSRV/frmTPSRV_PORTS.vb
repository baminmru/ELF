...
''' <summary>
'''Форма редактирования раздела Ком порты режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPSRV_PORTS
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPSRV_PORTS As TPSRVGUI.editTPSRV_PORTS
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPSRV_PORTS = New TPSRVGUI.EditTPSRV_PORTS
        ...
        'EditTPSRV_PORTS
        '
        Me.EditTPSRV_PORTS.AutoScroll = True
        Me.EditTPSRV_PORTS.Location = New System.Drawing.Point(8, 8)
        Me.EditTPSRV_PORTS.name = "EditTPSRV_PORTS"
        Me.EditTPSRV_PORTS.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPSRV_PORTS.TabIndex = 20
        Me.EditTPSRV_PORTS.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPSRV_PORTS
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPSRV_PORTS)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPSRV_PORTS"
        Me.Text = "Ком порты"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPSRV.TPSRV.TPSRV_PORTS)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPSRV_PORTS.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPSRV_PORTS_Changed() Handles EditTPSRV_PORTS.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPSRV_PORTS.IsOK() Then
          EditTPSRV_PORTS.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPSRV_PORTS.GetMaxX() + 10, EditTPSRV_PORTS.GetMaxY() + 35)
