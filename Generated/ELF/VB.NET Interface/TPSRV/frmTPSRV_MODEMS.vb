...
''' <summary>
'''Форма редактирования раздела Модемы режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPSRV_MODEMS
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPSRV_MODEMS As TPSRVGUI.editTPSRV_MODEMS
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPSRV_MODEMS = New TPSRVGUI.EditTPSRV_MODEMS
        ...
        'EditTPSRV_MODEMS
        '
        Me.EditTPSRV_MODEMS.AutoScroll = True
        Me.EditTPSRV_MODEMS.Location = New System.Drawing.Point(8, 8)
        Me.EditTPSRV_MODEMS.name = "EditTPSRV_MODEMS"
        Me.EditTPSRV_MODEMS.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPSRV_MODEMS.TabIndex = 20
        Me.EditTPSRV_MODEMS.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPSRV_MODEMS
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPSRV_MODEMS)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPSRV_MODEMS"
        Me.Text = "Модемы"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPSRV.TPSRV.TPSRV_MODEMS)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPSRV_MODEMS.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPSRV_MODEMS_Changed() Handles EditTPSRV_MODEMS.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPSRV_MODEMS.IsOK() Then
          EditTPSRV_MODEMS.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPSRV_MODEMS.GetMaxX() + 10, EditTPSRV_MODEMS.GetMaxY() + 35)
