...
''' <summary>
'''Форма редактирования раздела Результат обработки режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPQ_result
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPQ_result As TPQGUI.editTPQ_result
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPQ_result = New TPQGUI.EditTPQ_result
        ...
        'EditTPQ_result
        '
        Me.EditTPQ_result.AutoScroll = True
        Me.EditTPQ_result.Location = New System.Drawing.Point(8, 8)
        Me.EditTPQ_result.name = "EditTPQ_result"
        Me.EditTPQ_result.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPQ_result.TabIndex = 20
        Me.EditTPQ_result.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPQ_result
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPQ_result)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPQ_result"
        Me.Text = "Результат обработки"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPQ.TPQ.TPQ_result)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPQ_result.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPQ_result_Changed() Handles EditTPQ_result.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPQ_result.GetMaxX() + 10, EditTPQ_result.GetMaxY() + 35)
