...
''' <summary>
'''Форма редактирования раздела Параметры на схеме режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLS_PARAM
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLS_PARAM As TPLSGUI.editTPLS_PARAM
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLS_PARAM = New TPLSGUI.EditTPLS_PARAM
        ...
        'EditTPLS_PARAM
        '
        Me.EditTPLS_PARAM.AutoScroll = True
        Me.EditTPLS_PARAM.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLS_PARAM.name = "EditTPLS_PARAM"
        Me.EditTPLS_PARAM.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLS_PARAM.TabIndex = 20
        Me.EditTPLS_PARAM.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLS_PARAM
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLS_PARAM)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLS_PARAM"
        Me.Text = "Параметры на схеме"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLS.TPLS.TPLS_PARAM)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLS_PARAM.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLS_PARAM_Changed() Handles EditTPLS_PARAM.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLS_PARAM.GetMaxX() + 10, EditTPLS_PARAM.GetMaxY() + 35)
