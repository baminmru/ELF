...
''' <summary>
'''Форма редактирования раздела Параметры соединения режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLT_CONNECT
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLT_CONNECT As TPLTGUI.editTPLT_CONNECT
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLT_CONNECT = New TPLTGUI.EditTPLT_CONNECT
        ...
        'EditTPLT_CONNECT
        '
        Me.EditTPLT_CONNECT.AutoScroll = True
        Me.EditTPLT_CONNECT.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLT_CONNECT.name = "EditTPLT_CONNECT"
        Me.EditTPLT_CONNECT.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLT_CONNECT.TabIndex = 20
        Me.EditTPLT_CONNECT.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLT_CONNECT
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLT_CONNECT)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLT_CONNECT"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLT.TPLT.TPLT_CONNECT)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLT_CONNECT.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLT_CONNECT_Changed() Handles EditTPLT_CONNECT.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLT_CONNECT.IsOK() Then
          EditTPLT_CONNECT.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLT_CONNECT.GetMaxX() + 10, EditTPLT_CONNECT.GetMaxY() + 35)
