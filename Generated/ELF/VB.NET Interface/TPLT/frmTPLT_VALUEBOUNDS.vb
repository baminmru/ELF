...
''' <summary>
'''Форма редактирования раздела Граничные значения режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLT_VALUEBOUNDS
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLT_VALUEBOUNDS As TPLTGUI.editTPLT_VALUEBOUNDS
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLT_VALUEBOUNDS = New TPLTGUI.EditTPLT_VALUEBOUNDS
        ...
        '
        'EditTPLT_VALUEBOUNDS
        '
        Me.EditTPLT_VALUEBOUNDS.AutoScroll = True
        Me.EditTPLT_VALUEBOUNDS.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLT_VALUEBOUNDS.name = "EditTPLT_VALUEBOUNDS"
        Me.EditTPLT_VALUEBOUNDS.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLT_VALUEBOUNDS.TabIndex = 20
        Me.EditTPLT_VALUEBOUNDS.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLT_VALUEBOUNDS
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLT_VALUEBOUNDS)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLT_VALUEBOUNDS"
        Me.Text = "Граничные значения"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLT.TPLT.TPLT_VALUEBOUNDS)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLT_VALUEBOUNDS.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLT_VALUEBOUNDS_Changed() Handles EditTPLT_VALUEBOUNDS.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLT_VALUEBOUNDS.IsOK() Then
          EditTPLT_VALUEBOUNDS.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLT_VALUEBOUNDS.GetMaxX() + 10, EditTPLT_VALUEBOUNDS.GetMaxY() + 35)
