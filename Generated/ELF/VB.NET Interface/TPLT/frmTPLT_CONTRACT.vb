...
''' <summary>
'''Форма редактирования раздела Договорные установки режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLT_CONTRACT
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLT_CONTRACT As TPLTGUI.editTPLT_CONTRACT
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLT_CONTRACT = New TPLTGUI.EditTPLT_CONTRACT
        ...
        'EditTPLT_CONTRACT
        '
        Me.EditTPLT_CONTRACT.AutoScroll = True
        Me.EditTPLT_CONTRACT.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLT_CONTRACT.name = "EditTPLT_CONTRACT"
        Me.EditTPLT_CONTRACT.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLT_CONTRACT.TabIndex = 20
        Me.EditTPLT_CONTRACT.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLT_CONTRACT
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLT_CONTRACT)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLT_CONTRACT"
        Me.Text = "Договорные установки"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLT.TPLT.TPLT_CONTRACT)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLT_CONTRACT.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLT_CONTRACT_Changed() Handles EditTPLT_CONTRACT.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLT_CONTRACT.IsOK() Then
          EditTPLT_CONTRACT.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLT_CONTRACT.GetMaxX() + 10, EditTPLT_CONTRACT.GetMaxY() + 35)
