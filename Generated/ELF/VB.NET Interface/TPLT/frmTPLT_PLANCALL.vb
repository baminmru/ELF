...
''' <summary>
'''Форма редактирования раздела План опроса устройств режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLT_PLANCALL
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLT_PLANCALL As TPLTGUI.editTPLT_PLANCALL
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLT_PLANCALL = New TPLTGUI.EditTPLT_PLANCALL
        ...
        'EditTPLT_PLANCALL
        '
        Me.EditTPLT_PLANCALL.AutoScroll = True
        Me.EditTPLT_PLANCALL.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLT_PLANCALL.name = "EditTPLT_PLANCALL"
        Me.EditTPLT_PLANCALL.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLT_PLANCALL.TabIndex = 20
        Me.EditTPLT_PLANCALL.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLT_PLANCALL
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLT_PLANCALL)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLT_PLANCALL"
        Me.Text = "План опроса устройств"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLT.TPLT.TPLT_PLANCALL)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLT_PLANCALL.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLT_PLANCALL_Changed() Handles EditTPLT_PLANCALL.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLT_PLANCALL.IsOK() Then
          EditTPLT_PLANCALL.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLT_PLANCALL.GetMaxX() + 10, EditTPLT_PLANCALL.GetMaxY() + 35)
