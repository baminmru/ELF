...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLT_REPORTS As TPLTGUI.editTPLT_REPORTS
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLT_REPORTS = New TPLTGUI.EditTPLT_REPORTS
        ...
        'EditTPLT_REPORTS
        '
        Me.EditTPLT_REPORTS.AutoScroll = True
        Me.EditTPLT_REPORTS.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLT_REPORTS.name = "EditTPLT_REPORTS"
        Me.EditTPLT_REPORTS.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLT_REPORTS.TabIndex = 20
        Me.EditTPLT_REPORTS.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLT_REPORTS
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLT_REPORTS)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLT_REPORTS"
        Me.Text = "Отчеты"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLT.TPLT.TPLT_REPORTS)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLT_REPORTS.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLT_REPORTS_Changed() Handles EditTPLT_REPORTS.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLT_REPORTS.IsOK() Then
          EditTPLT_REPORTS.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLT_REPORTS.GetMaxX() + 10, EditTPLT_REPORTS.GetMaxY() + 35)
