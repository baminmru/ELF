...
Public Class viewTPLT_VALUEBOUNDS
...
''' </remarks>
    Public Sub Init()
        ...
        Dim dt As DataTable
        dt = item.TPLT_VALUEBOUNDS.GetDataTable()
        dt.TableName = "TPLT_VALUEBOUNDS"

        ts = New DataGridTableStyle
        ts.MappingName = "TPLT_VALUEBOUNDS"
        ts.ReadOnly = True
        ...
        cs.MappingName = "PNAME"
        cs.NullText = ""
        ts.GridColumnStyles.Add (cs)

        cs = New DataGridTextBoxColumn
         cs.ReadOnly = True
        cs.HeaderText = "Тип архива"
        cs.MappingName = "PTYPE"
        cs.NullText = ""
        ts.GridColumnStyles.Add (cs)

        cs = New DataGridTextBoxColumn
         cs.ReadOnly = True
        cs.HeaderText = "Минимальное значение"
        cs.MappingName = "PMIN"
        cs.NullText = ""
        ts.GridColumnStyles.Add (cs)
        ...
        cs = New DataGridTextBoxColumn
         cs.ReadOnly = True
        cs.HeaderText = "Максимальное значение"
        cs.MappingName = "PMAX"
        cs.NullText = ""
        ts.GridColumnStyles.Add (cs)
        ...
        cs = New DataGridTextBoxColumn
         cs.ReadOnly = True
        cs.HeaderText = "Проверять на минимум"
        cs.MappingName = "ISMIN"
        cs.NullText = ""
        ts.GridColumnStyles.Add (cs)

        cs = New DataGridTextBoxColumn
         cs.ReadOnly = True
        cs.HeaderText = "Проверять на максимум"
        cs.MappingName = "ISMAX"
        cs.NullText = ""
        ts.GridColumnStyles.Add (cs)
...
''' </remarks>
    Private Sub gv_OnEdit(ByRef OK As Boolean, ByVal ID As System.Guid) Handles gv.OnGridEdit
        Dim ed As TPLT.TPLT.TPLT_VALUEBOUNDS
        ed = item.FindRowObject("TPLT_VALUEBOUNDS", ID)
    ...
    Private Sub gv_OnAdd(ByRef OK As Boolean, ByVal ID As System.Guid) Handles gv.OnGridAdd
      If not mReadOnly Then
        ...
        If ID.Equals(System.guid.Empty) Then
              ed = Item.TPLT_VALUEBOUNDS.Add
          Else
              ed = Item.TPLT_VALUEBOUNDS.Add(ID.ToString())
          End If
        Dim gui As Doc_GUIBase
        Dim dt As DataTable
        gui = GuiManager.GetTypeGUI(ed.Application.TypeName)
