...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLT_BDEVICES As TPLTGUI.editTPLT_BDEVICES
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLT_BDEVICES = New TPLTGUI.EditTPLT_BDEVICES
        ...
        'EditTPLT_BDEVICES
        '
        Me.EditTPLT_BDEVICES.AutoScroll = True
        Me.EditTPLT_BDEVICES.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLT_BDEVICES.name = "EditTPLT_BDEVICES"
        Me.EditTPLT_BDEVICES.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLT_BDEVICES.TabIndex = 20
        Me.EditTPLT_BDEVICES.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLT_BDEVICES
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLT_BDEVICES)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLT_BDEVICES"
        Me.Text = "Описание"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLT.TPLT.TPLT_BDEVICES)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLT_BDEVICES.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLT_BDEVICES_Changed() Handles EditTPLT_BDEVICES.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLT_BDEVICES.IsOK() Then
          EditTPLT_BDEVICES.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLT_BDEVICES.GetMaxX() + 10, EditTPLT_BDEVICES.GetMaxY() + 35)
