...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents ViewTPN_DEF As TPNGUI.viewTPN_DEF
   
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.tab = New System.Windows.Forms.TabControl
   TabPage1 = New System.Windows.Forms.TabPage
   ViewTPN_DEF = new viewTPN_DEF
   ...
   Me.TabPage1.SuspendLayout()
        ...
        'TabPage1
        '
        Me.TabPage1.Controls.Add (Me.ViewTPN_DEF)
        ...
        'ViewTPN_DEF
        '
        Me.ViewTPN_DEF.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ViewTPN_DEF.Location = New System.Drawing.Point(0, 0)
        Me.ViewTPN_DEF.name = "ViewTPN_DEF"
        Me.ViewTPN_DEF.Size = New System.Drawing.Size(504, 352)
        Me.ViewTPN_DEF.TabIndex = 0
...
''' </remarks>
    Public Sub Attach(ByVal docItem As LATIR2.Document.Doc_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, byval DocReadOnly as boolean  ) Implements LATIR2GUIManager.IViewPanel.Attach
        ...
        GuiManager = gm
        ViewTPN_DEF.Attach(item, GuiManager,DocReadOnly)
    End Sub
...
''' </remarks>
    ...
    Dim ok As Boolean
    ok = True
        ok = ok And ViewTPN_DEF.Save(Sielent, NoError)
       Return ok
    End function
...
''' </remarks>
    ...
    ok = False
        ok = ok or ViewTPN_DEF.IsChanged()
       Return ok
    End function
