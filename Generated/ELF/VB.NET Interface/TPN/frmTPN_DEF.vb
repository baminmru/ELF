...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPN_DEF As TPNGUI.editTPN_DEF
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPN_DEF = New TPNGUI.EditTPN_DEF
        ...
        'EditTPN_DEF
        '
        Me.EditTPN_DEF.AutoScroll = True
        Me.EditTPN_DEF.Location = New System.Drawing.Point(8, 8)
        Me.EditTPN_DEF.name = "EditTPN_DEF"
        Me.EditTPN_DEF.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPN_DEF.TabIndex = 20
        Me.EditTPN_DEF.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPN_DEF
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPN_DEF)
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPN.TPN.TPN_DEF)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPN_DEF.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPN_DEF_Changed() Handles EditTPN_DEF.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPN_DEF.GetMaxX() + 10, EditTPN_DEF.GetMaxY() + 35)
