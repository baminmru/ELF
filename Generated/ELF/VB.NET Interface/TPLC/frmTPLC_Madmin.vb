...
''' <summary>
'''Форма редактирования раздела Мгновенные значения режим:admin
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLC_Madmin
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLC_M As TPLCGUI.editTPLC_Madmin
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLC_M = New TPLCGUI.EditTPLC_Madmin
        ...
        'EditTPLC_M
        '
        Me.EditTPLC_M.AutoScroll = True
        Me.EditTPLC_M.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLC_M.name = "EditTPLC_M"
        Me.EditTPLC_M.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLC_M.TabIndex = 20
        Me.EditTPLC_M.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLC_M
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLC_M)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLC_M"
        Me.Text = "Мгновенные значения"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLC.TPLC.TPLC_M)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLC_M.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLC_M_Changed() Handles EditTPLC_M.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLC_M.GetMaxX() + 10, EditTPLC_M.GetMaxY() + 35)
