...
''' <summary>
'''Форма редактирования раздела Суточный архив режим:admin
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLC_Dadmin
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLC_D As TPLCGUI.editTPLC_Dadmin
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLC_D = New TPLCGUI.EditTPLC_Dadmin
        ...
        'EditTPLC_D
        '
        Me.EditTPLC_D.AutoScroll = True
        Me.EditTPLC_D.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLC_D.name = "EditTPLC_D"
        Me.EditTPLC_D.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLC_D.TabIndex = 20
        Me.EditTPLC_D.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLC_D
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLC_D)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLC_D"
        Me.Text = "Суточный архив"
...
#End Region
    Public Item As TPLC.TPLC.TPLC_D
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLC.TPLC.TPLC_D)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLC_D.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLC_D_Changed() Handles EditTPLC_D.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLC_D.GetMaxX() + 10, EditTPLC_D.GetMaxY() + 35)
