...
''' <summary>
'''Форма редактирования раздела Заголовок режим:admin
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLC_HEADERadmin
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLC_HEADER As TPLCGUI.editTPLC_HEADERadmin
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLC_HEADER = New TPLCGUI.EditTPLC_HEADERadmin
        ...
        'EditTPLC_HEADER
        '
        Me.EditTPLC_HEADER.AutoScroll = True
        Me.EditTPLC_HEADER.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLC_HEADER.name = "EditTPLC_HEADER"
        Me.EditTPLC_HEADER.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLC_HEADER.TabIndex = 20
        Me.EditTPLC_HEADER.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLC_HEADER
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLC_HEADER)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLC_HEADER"
        Me.Text = "Заголовок"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLC.TPLC.TPLC_HEADER)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLC_HEADER.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLC_HEADER_Changed() Handles EditTPLC_HEADER.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If EditTPLC_HEADER.IsOK() Then
          EditTPLC_HEADER.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLC_HEADER.GetMaxX() + 10, EditTPLC_HEADER.GetMaxY() + 35)
