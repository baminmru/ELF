...
''' <summary>
'''Форма редактирования раздела Суммарные показатели режим:admin
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmTPLC_Tadmin
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents EditTPLC_T As TPLCGUI.editTPLC_Tadmin
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.EditTPLC_T = New TPLCGUI.EditTPLC_Tadmin
        ...
        'EditTPLC_T
        '
        Me.EditTPLC_T.AutoScroll = True
        Me.EditTPLC_T.Location = New System.Drawing.Point(8, 8)
        Me.EditTPLC_T.name = "EditTPLC_T"
        Me.EditTPLC_T.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.EditTPLC_T.TabIndex = 20
        Me.EditTPLC_T.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmTPLC_T
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (EditTPLC_T)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmTPLC_T"
        Me.Text = "Суммарные показатели"
...
#End Region
    Public Item As TPLC.TPLC.TPLC_T
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, TPLC.TPLC.TPLC_T)
        GuiManager = gm
        mReadOnly = FormReadOnly
        EditTPLC_T.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub EditTPLC_T_Changed() Handles EditTPLC_T.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(EditTPLC_T.GetMaxX() + 10, EditTPLC_T.GetMaxY() + 35)
