...
''' <summary>
'''Реализация строки раздела Модемы
''' </summary>
''' <remarks>
'''
''' </remarks>
    Public Class TPSRV_MODEMS
        Inherits LATIR2.Document.DocRow_Base



''' <summary>
'''Локальная переменная для поля Номер ком порта
''' </summary>
''' <remarks>
'''
''' </remarks>
            private m_PortNum  as String
...
''' </remarks>
        Public Overrides Sub Pack(ByVal nv As LATIR2.NamedValues)
          nv.Add("PortNum", PortNum, dbtype.string)
...
''' </remarks>
        Public Overrides Sub Unpack(ByVal reader As System.Data.DataRow)
            ...
            RowRetrived = True
            RetriveTime = Now
          If reader.Table.Columns.Contains("PortNum") Then m_PortNum=reader.item("PortNum").ToString()
