...
''' <summary>
'''Реализация строки раздела Описание сервера
''' </summary>
''' <remarks>
'''
''' </remarks>
    Public Class TPSRV_INFO
        Inherits LATIR2.Document.DocRow_Base



''' <summary>
'''Локальная переменная для поля Имя сервера
''' </summary>
''' <remarks>
'''
''' </remarks>
...
''' <summary>
'''Локальная переменная для поля IP сервера
''' </summary>
''' <remarks>
'''
''' </remarks>
