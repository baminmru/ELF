...
''' <summary>
'''Реализация раздела Суммарные показателив виде коллекции
''' </summary>
''' <remarks>
'''
''' </remarks>
    Public Class TPLC_T_col
...
'''
''' </remarks>
        Public Function GetItem( vIndex as object ) As TPLC.TPLC_T
            try
            GetItem = Convert.ChangeType(mybase.Item(vIndex), GetType(TPLC.TPLC_T))
...
'''
''' </remarks>
        Public Shadows Function Item( vIndex as object ) As TPLC.TPLC_T
          try
