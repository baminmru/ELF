...
''' <summary>
'''Реализация раздела Суточный архивв виде коллекции
''' </summary>
''' <remarks>
'''
''' </remarks>
    Public Class TPLC_D_col
...
'''
''' </remarks>
        Public Function GetItem( vIndex as object ) As TPLC.TPLC_D
            try
            GetItem = Convert.ChangeType(mybase.Item(vIndex), GetType(TPLC.TPLC_D))
...
'''
''' </remarks>
        Public Shadows Function Item( vIndex as object ) As TPLC.TPLC_D
          try
