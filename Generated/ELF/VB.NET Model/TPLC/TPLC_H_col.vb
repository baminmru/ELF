...
''' <summary>
'''Реализация раздела Часовые архивыв виде коллекции
''' </summary>
''' <remarks>
'''
''' </remarks>
    Public Class TPLC_H_col
...
'''
''' </remarks>
        Public Function GetItem( vIndex as object ) As TPLC.TPLC_H
            try
            GetItem = Convert.ChangeType(mybase.Item(vIndex), GetType(TPLC.TPLC_H))
...
'''
''' </remarks>
        Public Shadows Function Item( vIndex as object ) As TPLC.TPLC_H
          try
