...
'''
''' </remarks>
  Private m_bpc_info As bpc_info_col
...
'''
''' </remarks>
        Public ReadOnly Property bpc_info() As bpc_info_col
            Get
                If m_bpc_info Is Nothing Then
                    m_bpc_info = New bpc_info_col
                    m_bpc_info.Application = Me
                    m_bpc_info.Parent = Me
                    m_bpc_info.Refresh()
                End If
                bpc_info = m_bpc_info
            End Get
...
''' </remarks>
        ...
        FindInCollections = Nothing
            ...
            mFindInCollections = bpc_info.FindObject(Table, InstID)
...
''' </remarks>
        Protected Overrides Sub XMLLoadCollections(ByVal node As System.Xml.XmlNode, Optional ByVal LoadMode As Integer = 0)
           ...
           try
            e_list = node.SelectNodes("bpc_info_COL")
            bpc_info.XMLLoad(e_list, LoadMode)
