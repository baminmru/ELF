...
''' <summary>
''' Внутренняя переменная для раздела Модуль
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_iu_rcfg_mod As iu_rcfg_mod_col


''' <summary>
'''Свойство для доступа к строкам раздела Модуль
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property iu_rcfg_mod() As iu_rcfg_mod_col
            Get
                If m_iu_rcfg_mod Is Nothing Then
                    m_iu_rcfg_mod = New iu_rcfg_mod_col
                    m_iu_rcfg_mod.Application = Me
                    m_iu_rcfg_mod.Parent = Me
                    m_iu_rcfg_mod.Refresh()
                End If
                iu_rcfg_mod = m_iu_rcfg_mod
            End Get
        End Property


''' <summary>
''' Внутренняя переменная для раздела Режим документа
''' </summary>
''' <remarks>
'''
''' </remarks>
  Private m_iu_rcfg_docmode As iu_rcfg_docmode_col


''' <summary>
'''Свойство для доступа к строкам раздела Режим документа
''' </summary>
''' <remarks>
'''
''' </remarks>
        Public ReadOnly Property iu_rcfg_docmode() As iu_rcfg_docmode_col
            Get
                If m_iu_rcfg_docmode Is Nothing Then
                    m_iu_rcfg_docmode = New iu_rcfg_docmode_col
                    m_iu_rcfg_docmode.Application = Me
                    m_iu_rcfg_docmode.Parent = Me
                    m_iu_rcfg_docmode.Refresh()
                End If
                iu_rcfg_docmode = m_iu_rcfg_docmode
            End Get
        End Property
...
'''
''' </remarks>
  Private m_iu_rcfg_def As iu_rcfg_def_col
...
'''
''' </remarks>
        Public ReadOnly Property iu_rcfg_def() As iu_rcfg_def_col
            Get
                If m_iu_rcfg_def Is Nothing Then
                    m_iu_rcfg_def = New iu_rcfg_def_col
                    m_iu_rcfg_def.Application = Me
                    m_iu_rcfg_def.Parent = Me
                    m_iu_rcfg_def.Refresh()
                End If
                iu_rcfg_def = m_iu_rcfg_def
            End Get
        End Property
...
''' </remarks>
        ...
        FindInCollections = Nothing
            ...
            mFindInCollections = iu_rcfg_def.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
            mFindInCollections = iu_rcfg_mod.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
            mFindInCollections = iu_rcfg_docmode.FindObject(Table, InstID)
            if not mFindInCollections is nothing then return mFindInCollections
        End Function
...
''' </remarks>
        Protected Overrides Sub XMLLoadCollections(ByVal node As System.Xml.XmlNode, Optional ByVal LoadMode As Integer = 0)
           ...
           try
            e_list = node.SelectNodes("iu_rcfg_def_COL")
            iu_rcfg_def.XMLLoad(e_list, LoadMode)
            e_list = node.SelectNodes("iu_rcfg_mod_COL")
            iu_rcfg_mod.XMLLoad(e_list, LoadMode)
            e_list = node.SelectNodes("iu_rcfg_docmode_COL")
            iu_rcfg_docmode.XMLLoad(e_list, LoadMode)
...
''' </remarks>
        Public Overrides Sub XMLSaveCollections(ByVal node As System.Xml.XmlElement, ByVal Xdom As System.Xml.XmlDocument)
            iu_rcfg_def.XMLSave(node, Xdom)
            iu_rcfg_mod.XMLSave(node, Xdom)
            iu_rcfg_docmode.XMLSave(node, Xdom)
        End Sub
...
Public Overrides Sub BatchUpdate()
    iu_rcfg_def.BatchUpdate
    iu_rcfg_mod.BatchUpdate
    iu_rcfg_docmode.BatchUpdate
End Sub
    End Class
End Namespace
