...
'''
''' </remarks>
  Private m_iu_crole As iu_crole_col
...
'''
''' </remarks>
        Public ReadOnly Property iu_crole() As iu_crole_col
            Get
                If m_iu_crole Is Nothing Then
                    m_iu_crole = New iu_crole_col
                    m_iu_crole.Application = Me
                    m_iu_crole.Parent = Me
                    m_iu_crole.Refresh()
                End If
                iu_crole = m_iu_crole
            End Get
...
''' </remarks>
        ...
        FindInCollections = Nothing
            ...
            mFindInCollections = iu_crole.FindObject(Table, InstID)
...
''' </remarks>
        Protected Overrides Sub XMLLoadCollections(ByVal node As System.Xml.XmlNode, Optional ByVal LoadMode As Integer = 0)
           ...
           try
            e_list = node.SelectNodes("iu_crole_COL")
            iu_crole.XMLLoad(e_list, LoadMode)
