...
''' <summary>
'''Реализация документа Структура меню приложения
''' </summary>
''' <remarks>
'''Интерфейс
''' </remarks>
...
'''
''' </remarks>
  Private m_iu_int_modules As iu_int_modules_col
...
'''
''' </remarks>
        Public ReadOnly Property iu_int_modules() As iu_int_modules_col
            Get
                If m_iu_int_modules Is Nothing Then
                    m_iu_int_modules = New iu_int_modules_col
                    m_iu_int_modules.Application = Me
                    m_iu_int_modules.Parent = Me
                    m_iu_int_modules.Refresh()
                End If
                iu_int_modules = m_iu_int_modules
            End Get
        End Property
...
''' </remarks>
        ...
        FindInCollections = Nothing
            ...
            mFindInCollections = iu_int_modules.FindObject(Table, InstID)
...
''' </remarks>
        Protected Overrides Sub XMLLoadCollections(ByVal node As System.Xml.XmlNode, Optional ByVal LoadMode As Integer = 0)
           ...
           try
            e_list = node.SelectNodes("iu_int_modules_COL")
            iu_int_modules.XMLLoad(e_list, LoadMode)
...
''' </remarks>
        Public Overrides Sub XMLSaveCollections(ByVal node As System.Xml.XmlElement, ByVal Xdom As System.Xml.XmlDocument)
            iu_int_modules.XMLSave(node, Xdom)
        End Sub
