...
''' <summary>
'''Форма редактирования раздела Роль режим:edit
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmiu_rcfg_defedit
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Editiu_rcfg_def As bprcfgGUI.editiu_rcfg_defedit
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Editiu_rcfg_def = New bprcfgGUI.Editiu_rcfg_defedit
        ...
        'Editiu_rcfg_def
        '
        Me.Editiu_rcfg_def.AutoScroll = True
        Me.Editiu_rcfg_def.Location = New System.Drawing.Point(8, 8)
        Me.Editiu_rcfg_def.name = "Editiu_rcfg_def"
        Me.Editiu_rcfg_def.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Editiu_rcfg_def.TabIndex = 20
        Me.Editiu_rcfg_def.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmiu_rcfg_def
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Editiu_rcfg_def)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmiu_rcfg_def"
        Me.Text = "Роль"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, bprcfg.bprcfg.iu_rcfg_def)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Editiu_rcfg_def.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Editiu_rcfg_def_Changed() Handles Editiu_rcfg_def.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If Editiu_rcfg_def.IsOK() Then
          Editiu_rcfg_def.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Editiu_rcfg_def.GetMaxX() + 10, Editiu_rcfg_def.GetMaxY() + 35)
