...
''' <summary>
'''Форма редактирования раздела Модуль режим:edit
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmiu_rcfg_modedit
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Editiu_rcfg_mod As bprcfgGUI.editiu_rcfg_modedit
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Editiu_rcfg_mod = New bprcfgGUI.Editiu_rcfg_modedit
        ...
        'Editiu_rcfg_mod
        '
        Me.Editiu_rcfg_mod.AutoScroll = True
        Me.Editiu_rcfg_mod.Location = New System.Drawing.Point(8, 8)
        Me.Editiu_rcfg_mod.name = "Editiu_rcfg_mod"
        Me.Editiu_rcfg_mod.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Editiu_rcfg_mod.TabIndex = 20
        Me.Editiu_rcfg_mod.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmiu_rcfg_mod
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Editiu_rcfg_mod)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmiu_rcfg_mod"
        Me.Text = "Модуль"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, bprcfg.bprcfg.iu_rcfg_mod)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Editiu_rcfg_mod.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Editiu_rcfg_mod_Changed() Handles Editiu_rcfg_mod.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If Editiu_rcfg_mod.IsOK() Then
          Editiu_rcfg_mod.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Editiu_rcfg_mod.GetMaxX() + 10, Editiu_rcfg_mod.GetMaxY() + 35)
