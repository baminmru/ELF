...
''' <summary>
'''Контрол редактирования раздела Режим документа режим:read
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class editiu_rcfg_docmoderead
...
Me.cmbAllowDelete.Enabled = true
        Me.AutoScroll = True
