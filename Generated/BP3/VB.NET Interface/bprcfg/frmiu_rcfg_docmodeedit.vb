...
''' <summary>
'''Форма редактирования раздела Режим документа режим:edit
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmiu_rcfg_docmodeedit
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Editiu_rcfg_docmode As bprcfgGUI.editiu_rcfg_docmodeedit
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Editiu_rcfg_docmode = New bprcfgGUI.Editiu_rcfg_docmodeedit
        ...
        'Editiu_rcfg_docmode
        '
        Me.Editiu_rcfg_docmode.AutoScroll = True
        Me.Editiu_rcfg_docmode.Location = New System.Drawing.Point(8, 8)
        Me.Editiu_rcfg_docmode.name = "Editiu_rcfg_docmode"
        Me.Editiu_rcfg_docmode.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Editiu_rcfg_docmode.TabIndex = 20
        Me.Editiu_rcfg_docmode.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmiu_rcfg_docmode
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Editiu_rcfg_docmode)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmiu_rcfg_docmode"
        Me.Text = "Режим документа"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, bprcfg.bprcfg.iu_rcfg_docmode)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Editiu_rcfg_docmode.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Editiu_rcfg_docmode_Changed() Handles Editiu_rcfg_docmode.Changed
...
''' </remarks>
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
      If Not mReadOnly Then
        If Editiu_rcfg_docmode.IsOK() Then
          Editiu_rcfg_docmode.Save()
         Try
          Item.Save()
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Editiu_rcfg_docmode.GetMaxX() + 10, Editiu_rcfg_docmode.GetMaxY() + 35)
