...
''' <summary>
'''Форма редактирования раздела Данные сотрудника режим:
''' </summary>
''' <remarks>
'''
''' </remarks>
Public Class frmiu_u_def
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Editiu_u_def As bpuGUI.editiu_u_def
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.btnPanel = New System.Windows.Forms.Panel
        Me.btnCancel = New System.Windows.Forms.Button
        Me.btnOK = New System.Windows.Forms.Button
        Me.Editiu_u_def = New bpuGUI.Editiu_u_def
        ...
        'Editiu_u_def
        '
        Me.Editiu_u_def.AutoScroll = True
        Me.Editiu_u_def.Location = New System.Drawing.Point(8, 8)
        Me.Editiu_u_def.name = "Editiu_u_def"
        Me.Editiu_u_def.Size = New System.Drawing.Size(800-40-16, 600-16)
        Me.Editiu_u_def.TabIndex = 20
        Me.Editiu_u_def.Dock = System.Windows.Forms.DockStyle.Fill
        '
        'frmiu_u_def
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(800, 600)
        Me.Controls.Add (Editiu_u_def)
        Me.Controls.Add (Me.btnPanel)
        Me.name = "frmiu_u_def"
        Me.Text = "Данные сотрудника"
...
''' </remarks>
    Public Sub Attach(ByVal RowItem As LATIR2.Document.DocRow_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, Optional ByVal FormReadOnly As Boolean =False)
        Item = CType(RowItem, bpu.bpu.iu_u_def)
        GuiManager = gm
        mReadOnly = FormReadOnly
        Editiu_u_def.Attach(GuiManager, Item, FormReadOnly)
        btnOK.Enabled = False
    End Sub

    Private Sub Editiu_u_def_Changed() Handles Editiu_u_def.Changed
...
''' </remarks>
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ClientSize() = New System.Drawing.Size(Editiu_u_def.GetMaxX() + 10, Editiu_u_def.GetMaxY() + 35)
