...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Viewiu_u_def As bpuGUI.viewiu_u_def
   
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Me.tab = New System.Windows.Forms.TabControl
   TabPage1 = New System.Windows.Forms.TabPage
   Viewiu_u_def = new viewiu_u_def
   ...
   Me.TabPage1.SuspendLayout()
        ...
        'TabPage1
        '
        Me.TabPage1.Controls.Add (Me.Viewiu_u_def)
        Me.TabPage1.Location = New System.Drawing.Point(-10000, -10000)
        Me.TabPage1.name = "TabPage1"
        Me.TabPage1.Text = "Данные сотрудника"
        ...
        'Viewiu_u_def
        '
        Me.Viewiu_u_def.Dock = System.Windows.Forms.DockStyle.Fill
        Me.Viewiu_u_def.Location = New System.Drawing.Point(0, 0)
        Me.Viewiu_u_def.name = "Viewiu_u_def"
        Me.Viewiu_u_def.Size = New System.Drawing.Size(504, 352)
        Me.Viewiu_u_def.TabIndex = 0
...
''' </remarks>
    Public Sub Attach(ByVal docItem As LATIR2.Document.Doc_Base, ByVal gm As LATIR2GuiManager.LATIRGuiManager, byval DocReadOnly as boolean  ) Implements LATIR2GUIManager.IViewPanel.Attach
        ...
        GuiManager = gm
        Viewiu_u_def.Attach(item, GuiManager,DocReadOnly)
    End Sub
...
''' </remarks>
    ...
    Dim ok As Boolean
    ok = True
        ok = ok And Viewiu_u_def.Save(Sielent, NoError)
       Return ok
    End function
...
''' </remarks>
    ...
    ok = False
        ok = ok or Viewiu_u_def.IsChanged()
       Return ok
    End function
